...
LightningDefineType(BitStreamExtended, builder, type)
{
  ...
  LightningBindOverloadedMethod(MeasureInteger2Quantized, LightningStaticOverload(Bits, const Math::IntVector2&, const Math::IntVector2&));
  LightningBindOverloadedMethod(MeasureInteger2Quantized, LightningStaticOverload(Bits, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));

  LightningBindOverloadedMethod(MeasureInteger3Quantized, LightningStaticOverload(Bits, const Math::IntVector3&, const Math::IntVector3&));
  LightningBindOverloadedMethod(MeasureInteger3Quantized, LightningStaticOverload(Bits, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&));

  LightningBindOverloadedMethod(MeasureInteger4Quantized, LightningStaticOverload(Bits, const Math::IntVector4&, const Math::IntVector4&));
  LightningBindOverloadedMethod(MeasureInteger4Quantized, LightningStaticOverload(Bits, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));
  ...
  LightningBindOverloadedMethod(MeasureReal2Quantized, LightningStaticOverload(Bits, const Math::Vector2&, const Math::Vector2&));
  LightningBindOverloadedMethod(MeasureReal2Quantized, LightningStaticOverload(Bits, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));

  LightningBindOverloadedMethod(MeasureReal3Quantized, LightningStaticOverload(Bits, const Math::Vector3&, const Math::Vector3&));
  LightningBindOverloadedMethod(MeasureReal3Quantized, LightningStaticOverload(Bits, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));

  LightningBindOverloadedMethod(MeasureReal4Quantized, LightningStaticOverload(Bits, const Math::Vector4&, const Math::Vector4&));
  LightningBindOverloadedMethod(MeasureReal4Quantized, LightningStaticOverload(Bits, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));
  ...
  LightningBindOverloadedMethod(WriteInteger2Quantized, LightningInstanceOverload(void, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));
  LightningBindOverloadedMethod(WriteInteger2Quantized, LightningInstanceOverload(void, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));

  LightningBindOverloadedMethod(WriteInteger3Quantized, LightningInstanceOverload(void, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&));
  LightningBindOverloadedMethod(WriteInteger3Quantized, LightningInstanceOverload(void, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&));

  LightningBindOverloadedMethod(WriteInteger4Quantized, LightningInstanceOverload(void, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));
  LightningBindOverloadedMethod(WriteInteger4Quantized, LightningInstanceOverload(void, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));
  ...
  LightningBindOverloadedMethod(WriteReal2Quantized, LightningInstanceOverload(void, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));
  LightningBindOverloadedMethod(WriteReal2Quantized, LightningInstanceOverload(void, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));

  LightningBindOverloadedMethod(WriteReal3Quantized, LightningInstanceOverload(void, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));
  LightningBindOverloadedMethod(WriteReal3Quantized, LightningInstanceOverload(void, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));

  LightningBindOverloadedMethod(WriteReal4Quantized, LightningInstanceOverload(void, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));
  LightningBindOverloadedMethod(WriteReal4Quantized, LightningInstanceOverload(void, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));
  ...
  LightningBindOverloadedMethod(CanReadInteger2Quantized, LightningConstInstanceOverload(bool, const Math::IntVector2&, const Math::IntVector2&));
  LightningBindOverloadedMethod(CanReadInteger2Quantized, LightningConstInstanceOverload(bool, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));

  LightningBindOverloadedMethod(CanReadInteger3Quantized, LightningConstInstanceOverload(bool, const Math::IntVector3&, const Math::IntVector3&));
  LightningBindOverloadedMethod(CanReadInteger3Quantized, LightningConstInstanceOverload(bool, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&));

  LightningBindOverloadedMethod(CanReadInteger4Quantized, LightningConstInstanceOverload(bool, const Math::IntVector4&, const Math::IntVector4&));
  LightningBindOverloadedMethod(CanReadInteger4Quantized, LightningConstInstanceOverload(bool, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));
  ...
  LightningBindOverloadedMethod(CanReadReal2Quantized, LightningConstInstanceOverload(bool, const Math::Vector2&, const Math::Vector2&));
  LightningBindOverloadedMethod(CanReadReal2Quantized, LightningConstInstanceOverload(bool, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));

  LightningBindOverloadedMethod(CanReadReal3Quantized, LightningConstInstanceOverload(bool, const Math::Vector3&, const Math::Vector3&));
  LightningBindOverloadedMethod(CanReadReal3Quantized, LightningConstInstanceOverload(bool, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));

  LightningBindOverloadedMethod(CanReadReal4Quantized, LightningConstInstanceOverload(bool, const Math::Vector4&, const Math::Vector4&));
  LightningBindOverloadedMethod(CanReadReal4Quantized, LightningConstInstanceOverload(bool, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));
  ...
  LightningBindOverloadedMethod(ReadInteger2Quantized, LightningConstInstanceOverload(Math::IntVector2, const Math::IntVector2&, const Math::IntVector2&));
  LightningBindOverloadedMethod(ReadInteger2Quantized, LightningConstInstanceOverload(Math::IntVector2, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));

  LightningBindOverloadedMethod(ReadInteger3Quantized, LightningConstInstanceOverload(Math::IntVector3, const Math::IntVector3&, const Math::IntVector3&));
  LightningBindOverloadedMethod(ReadInteger3Quantized, LightningConstInstanceOverload(Math::IntVector3, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&));

  LightningBindOverloadedMethod(ReadInteger4Quantized, LightningConstInstanceOverload(Math::IntVector4, const Math::IntVector4&, const Math::IntVector4&));
  LightningBindOverloadedMethod(ReadInteger4Quantized, LightningConstInstanceOverload(Math::IntVector4, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));
  ...
  LightningBindOverloadedMethod(ReadReal2Quantized, LightningConstInstanceOverload(Math::Vector2, const Math::Vector2&, const Math::Vector2&));
  LightningBindOverloadedMethod(ReadReal2Quantized, LightningConstInstanceOverload(Math::Vector2, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));

  LightningBindOverloadedMethod(ReadReal3Quantized, LightningConstInstanceOverload(Math::Vector3, const Math::Vector3&, const Math::Vector3&));
  LightningBindOverloadedMethod(ReadReal3Quantized, LightningConstInstanceOverload(Math::Vector3, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));

  LightningBindOverloadedMethod(ReadReal4Quantized, LightningConstInstanceOverload(Math::Vector4, const Math::Vector4&, const Math::Vector4&));
  LightningBindOverloadedMethod(ReadReal4Quantized, LightningConstInstanceOverload(Math::Vector4, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));
