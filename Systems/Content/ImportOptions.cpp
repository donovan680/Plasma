...
LightningDefineType(GeometryOptions, builder, type)
{
  ...
  LightningBindFieldProperty(mGenerateSmoothNormals)->AddAttributeChainable(PropertyAttributes::cInvalidatesObject)->PlasmaFilterBool(mImportMeshes);
  ...
  LightningBindFieldProperty(mScaleFactor)->PlasmaFilterEquality(mScaleConversion, ScaleConversion::Enum, ScaleConversion::Custom);
