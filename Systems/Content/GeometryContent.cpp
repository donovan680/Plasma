...
void CreateGeometryContent(ContentSystem* system)
{
  ...
  // Autodesk 
  system->CreatorsByExtension["fbx"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Wavefront Object
  system->CreatorsByExtension["obj"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Collada 
  system->CreatorsByExtension["dae"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Global Module in Basic Program
  system->CreatorsByExtension["glb"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // 3ds Max 3DS
  system->CreatorsByExtension["3ds"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Blender 3D
  system->CreatorsByExtension["blend"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // 3ds Max ASE
  system->CreatorsByExtension["ase"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Industry Foundation Classes (IFC/Step) NEEDS ADDITIONAL TESTING TO FIGURE OUT WHAT WENT WRONG
  system->CreatorsByExtension["ifc"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // XGL
  system->CreatorsByExtension["xgl"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  system->CreatorsByExtension["zgl"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Stanford Polygon Library
  system->CreatorsByExtension["ply"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // AutoCAD DXF
  system->CreatorsByExtension["dxf"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // LightWave 
  system->CreatorsByExtension["lwo"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // LightWave Scene
  system->CreatorsByExtension["lws"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Modo
  system->CreatorsByExtension["lxo"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Stereolithography 
  system->CreatorsByExtension["stl"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // DirectX X
  system->CreatorsByExtension["x"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // AC3D
  system->CreatorsByExtension["ac"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Milkshape 3D
  system->CreatorsByExtension["ms3d"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // TrueSpace 
  system->CreatorsByExtension["cob"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // untested truespace format
  system->CreatorsByExtension["scn"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  ...
  system->CreatorsByExtension["csm"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  
  // GRAPHICS ENGINE FORMATS
  // Ogre XML
  system->CreatorsByExtension["xml"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Irrlicht Mesh
  ...
  system->CreatorsByExtension["mdl"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Quake II
  system->CreatorsByExtension["md2"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Quake III Mesh
  system->CreatorsByExtension["md3"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  ...
  // Doom 3
  system->CreatorsByExtension["md5mesh"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Valve Model
  system->CreatorsByExtension["smd"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Open Game Engine Exchange
  system->CreatorsByExtension["ogex"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  
  // OTHER FILE FORMATS
  // BlitzBasic 3D
  system->CreatorsByExtension["b3d"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Quick3D
  system->CreatorsByExtension["q3o"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  system->CreatorsByExtension["q3s"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Neutral File Format && Sense8 WorldToolKit
  system->CreatorsByExtension["nff"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Object File Format
  system->CreatorsByExtension["off"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // PovRAY Raw
  system->CreatorsByExtension["raw"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Terragen Terrain
  system->CreatorsByExtension["ter"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // 3D GameStudio (3DGS) Terrain
  system->CreatorsByExtension["hmp"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
  // Nevercenter Silo Object
  system->CreatorsByExtension["sib"] = ContentTypeEntry(LightningTypeId(GeometryContent), MakeGeometryContent, UpdateGeometryContent);
