...
public:
  ...
  LightningScriptBuilder()
    :BaseTextBuilder(15, FileExtensionManager::GetLightningScriptTypeEntry()->GetDefaultExtensionWithDot(), LightningScriptResourceName) 
  {
  }
};
...
public:
  ...
  LightningFragmentBuilder()
    ...
    :BaseTextBuilder(9, FileExtensionManager::GetLightningFragmentTypeEntry()->GetDefaultExtensionWithDot(), "LightningFragment")
  {
  }
};
