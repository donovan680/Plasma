...
Vec3 GetFaceDirection(TextureFace::Enum face, float x, float y, float halfWidth)
{
  switch (face)
  {
    case Plasma::TextureFace::PositiveX: return Vec3(halfWidth, halfWidth - y, x - halfWidth);
    case Plasma::TextureFace::PositiveY: return Vec3(halfWidth - x, halfWidth, y - halfWidth);
    case Plasma::TextureFace::PositiveZ: return Vec3(halfWidth - x, halfWidth - y, halfWidth);
    case Plasma::TextureFace::NegativeX: return Vec3(-halfWidth, halfWidth - y, halfWidth - x);
    case Plasma::TextureFace::NegativeY: return Vec3(halfWidth - x, -halfWidth, halfWidth - y);
    case Plasma::TextureFace::NegativeZ: return Vec3(x - halfWidth, halfWidth - y, -halfWidth);
  }
