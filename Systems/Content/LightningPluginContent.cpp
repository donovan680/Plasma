///////////////////////////////////////////////////////////////////////////////
///
/// \file LightningPluginContent.cpp
/// 
...
void LightningPluginBuilder::Rename(StringParam newName)
{
  ...
  DoNotifyWarning("Lightning Plugin" , "You must rename the plugin directory and all the contents (projects, solutions, make files, etc)");
}
...
void LightningPluginBuilder::BuildContent(BuildOptions& buildOptions)
{
  ...
  // to build every time we run Plasma.
