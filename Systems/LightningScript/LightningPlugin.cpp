...
void LightningPluginSource::ForceCopyPluginDependencies()
{
  ...
  // This is setup within the Plasma engine build process (typically as a post build event)
  ...
  plasmaStubber.HppHeader = "/* Copyright 2016, DigiPen Institute of Technology */";
  plasmaStubber.CppHeader = "/* Copyright 2016, DigiPen Institute of Technology */";
  ...
  plasmaStubber.HppMiddle =
    "#define PlamaCogGetComponentTemplate                                      \\\n"
  ...
  plasmaStubber.HppFooter = 
    "namespace PlasmaEngine                                                       \n"
    "{                                                                          \n"
...
void LightningPluginSource::WriteCurrentVersionFile()
{
  ...
  String propsFile = BuildString(
    ...
    "  <PropertyGroup>\r\n"
    "    <PlasmaVersion>", revisionNumber, "</PlasmaVersion>\r\n"
    "  </PropertyGroup>\r\n"
    "</Project>\r\n");
...
bool LightningPluginSource::ShouldInstallIdeTools()
{
...
bool LightningPluginSource::IsIdeToolInstalled()
{
  ...
  size_t versionCount = LightningCArrayCount(cVersions);

  static const char* cExtensions[] =
  {
    "PlasmaLightningPlugins.Company.1794b5cc-5106-4426-a8e9-3610415a8dba,1.0"
  };
  size_t extensionCount = LightningCArrayCount(cExtensions);
...
LightningPluginSourceManager::LightningPluginSourceManager(BoundType* resourceType)
...
String LightningPluginLibrary::GetSharedLibraryPath() const
{
  ...
  if(SharedLibraryPath.Empty())
    return FilePath::CombineWithExtension(mResourceLibrary->Location, Name, LightningPluginBuilder::GetSharedLibraryExtension(true));
...
LightningPluginLibraryManager::LightningPluginLibraryManager(BoundType* resourceType)
  : ResourceManager(resourceType)
{
  mCanDuplicate = false;
  mCanReload = true;
