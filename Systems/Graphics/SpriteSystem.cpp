...
LightningDefineType(SpriteParticleSystem, builder, type)
{
  ...
  LightningBindFieldProperty(mBeamBaseScale)->PlasmaFilterEquality(mGeometryMode, SpriteParticleGeometryMode::Enum, SpriteParticleGeometryMode::Beam);
  LightningBindFieldProperty(mBeamVelocityScale)->PlasmaFilterEquality(mGeometryMode, SpriteParticleGeometryMode::Enum, SpriteParticleGeometryMode::Beam);
}
