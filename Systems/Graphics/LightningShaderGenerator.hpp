...
public:
  ...
  LibraryRef BuildFragmentsLibrary(Module& dependencies, Array<LightningDocumentResource*>& fragments, StringParam libraryName = "Fragments");
  ...
  bool CompilePipeline(LightningShaderIRType* shaderType, ShaderPipelineDescription& pipeline, Array<TranslationPassResultRef>& pipelineResults);
