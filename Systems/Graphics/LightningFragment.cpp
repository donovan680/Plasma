...
//**************************************************************************************************
void LightningFragment::AddKeywords(Array<Completion>& keywordsOut, const Array<String>& keyswords, HashSet<String>& keywordsToSkip)
{
...
void LightningFragment::GetLibrariesRecursive(Array<LibraryRef>& libraries, ResourceLibrary* library)
{
  ...
  if(library->mSwapFragment.mCurrentLibrary != nullptr)
  {
    ...
    LightningShaderIRLibrary* internalFragmentLibrary = graphicsEngine->mShaderGenerator->GetInternalLibrary(wrapperLibrary);
...
//**************************************************************************************************
void LightningFragmentManager::DispatchScriptError(StringParam eventId, StringParam shortMessage,
                                               StringParam fullMessage, const Lightning::CodeLocation& location)
{
