...
LightningDefineType(RenderTasksEvent, builder, type)
{
  ...
  LightningBindOverloadedMethod(GetRenderTarget, LightningInstanceOverload(HandleOf<RenderTarget>, IntVec2, TextureFormat::Enum));
  LightningBindOverloadedMethod(GetRenderTarget, LightningInstanceOverload(HandleOf<RenderTarget>, IntVec2, TextureFormat::Enum, SamplerSettings&));
  ...
  LightningBindOverloadedMethod(AddRenderTaskClearTarget, LightningInstanceOverload(void, RenderTarget*, RenderTarget*, Vec4, float));
  LightningBindOverloadedMethod(AddRenderTaskClearTarget, LightningInstanceOverload(void, RenderTarget*, RenderTarget*, Vec4, float, uint));
  LightningBindOverloadedMethod(AddRenderTaskClearTarget, LightningInstanceOverload(void, RenderTarget*, RenderTarget*, Vec4, float, uint, uint));
  LightningBindOverloadedMethod(AddRenderTaskClearTarget, LightningInstanceOverload(void, GraphicsRenderSettings&, Vec4));
  LightningBindOverloadedMethod(AddRenderTaskClearTarget, LightningInstanceOverload(void, GraphicsRenderSettings&, Vec4, float));
  LightningBindOverloadedMethod(AddRenderTaskClearTarget, LightningInstanceOverload(void, GraphicsRenderSettings&, Vec4, float, uint));
  LightningBindOverloadedMethod(AddRenderTaskClearTarget, LightningInstanceOverload(void, GraphicsRenderSettings&, Vec4, float, uint, uint));

  LightningBindOverloadedMethod(AddRenderTaskRenderPass, LightningInstanceOverload(void, GraphicsRenderSettings&, RenderGroup&, MaterialBlock&));
  LightningBindOverloadedMethod(AddRenderTaskRenderPass, LightningInstanceOverload(void, GraphicsRenderSettings&, GraphicalRangeInterface&, MaterialBlock&));
  ...
  LightningBindOverloadedMethod(AddRenderTaskPostProcess, LightningInstanceOverload(void, GraphicsRenderSettings&, MaterialBlock&));

  LightningBindOverloadedMethod(GetFinalTarget, LightningInstanceOverload(HandleOf<RenderTarget>, IntVec2, TextureFormat::Enum));
  LightningBindOverloadedMethod(GetFinalTarget, LightningInstanceOverload(HandleOf<RenderTarget>, IntVec2, TextureFormat::Enum, SamplerSettings&));
}
...
{
  Pair<u64, uint> key((u64)material->mResourceId.mValue, shaderInputsId);
