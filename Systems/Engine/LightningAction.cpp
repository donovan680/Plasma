...
void AddLightningActionProperty(LibraryBuilder& library)
{
  ...
  library.AddExtensionFunction(LightningTypeId(Action), "Property", CreateLightningPropertyAction<PropertyType, EaserType>, params, LightningTypeId(Action), FunctionOptions::Static);
}
...
void AddCall(LibraryBuilder& library)
{
  ...
  library.AddExtensionFunction(LightningTypeId(Action), "Call", CreateCallAction, params, LightningTypeId(Action), FunctionOptions::Static);
...
void AddDelay(LibraryBuilder& library)
{
  ...
  library.AddExtensionFunction(LightningTypeId(Action), "Delay", CreateDelayAction, params, LightningTypeId(ActionDelay), FunctionOptions::Static);
}
...
void AddEvent(LibraryBuilder& library)
{
  ...
  library.AddExtensionFunction(LightningTypeId(Action), "Event", CreateEventAction, params, LightningTypeId(Action), FunctionOptions::Static);
}
...
void AddActionSet(cstr name, LibraryBuilder& library)
{
  ...
  DelegateParameter& p0 = params.PushBack();
  p0.ParameterType = LightningTypeId(ActionSet);
  library.AddExtensionFunction(LightningTypeId(Action), name, CreateActionType<ActionType>, params, LightningTypeId(ActionType), FunctionOptions::Static);
}
