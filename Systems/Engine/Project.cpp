...
LightningDefineType(WindowLaunchSettings, builder, type)
{
  ...
  LightningBindFieldProperty(mLaunchFullscreen);//->PlasmaFilterEquality(mUseLaunchOptionsPopup, bool, false);
  LightningBindFieldProperty(mWindowedResolution);//->PlasmaFilterEquality(mUseLaunchOptionsPopup, bool, false);
}
