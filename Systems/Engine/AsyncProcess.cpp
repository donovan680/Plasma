...
LightningDefineType(AsyncProcess, builder, type)
{
  ...
  LightningFullBindMethod(builder, type, &AsyncProcess::Start, LightningInstanceOverload(bool, ProcessStartInfo&), "Start", "startInfo");
  ...
  LightningFullBindMethod(builder, type, &AsyncProcess::WaitForClose, LightningInstanceOverload(int, int), "WaitForClose", "milliseconds");
