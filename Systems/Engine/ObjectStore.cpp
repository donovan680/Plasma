...
{
  String storePath = FilePath::Combine(GetUserDocumentsDirectory(), "Plasma", storeName);
...
void ObjectStore::SetupDirectory()
{
  if(mStorePath.Empty())
  {
    ...
    String storePath = FilePath::Combine(GetUserDocumentsDirectory(), "Plasma", mStoreName);
...
void ObjectStore::Erase(StringParam name)
{
  ...
  if(FileExists(storeFile))
  {
    ...
    String trashDirectory = FilePath::Combine(GetUserDocumentsDirectory(), "Plasma", "Trash");
