...
void MusicNotificationObject::ProcessAndNotify(float currentTime, SoundInstance* instance)
{
  ...
  if ((int)beats > mTotalBeats)
  {
    ...
    if (mBeatsCount == mBeatsPerBar)
    {
      ...
      // Send notification
      PL::gSound->Mixer.AddTaskThreaded(CreateFunctor(&SoundInstance::DispatchInstanceEventFromMixThread,
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&SoundInstance::SetVolumeThreaded, this,
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&SoundInstance::SetPitchThreaded, this,
...
void SoundInstance::InterpolateSemitones(float newSemitones, float interpolationTime)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&SoundInstance::SetPitchThreaded, this, newSemitones,
...
void SoundInstance::SetLoopTailTime(float seconds)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&SoundInstance::mLoopTailFramesThreaded, this, 
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&SoundInstance::SetTimeSignatureThreaded, this, beats, 
    noteType), this);
}
