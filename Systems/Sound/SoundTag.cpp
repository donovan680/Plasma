...
void TagObject::SetCompressorThresholdDb(float decibels)
{
  ...
  // TODO no handle
  PL::gSound->Mixer.AddTask(CreateFunctor(&DynamicsProcessor::SetThreshold, &CompressorObjectThreaded,
    decibels), nullptr);
}
...
void TagObject::SetCompressorAttackMs(float milliseconds)
{
  ...
  // TODO no handle
  PL::gSound->Mixer.AddTask(CreateFunctor(&DynamicsProcessor::SetAttackMSec, &CompressorObjectThreaded,
...
void TagObject::SetCompressorReleaseMs(float milliseconds)
{
  ...
  // TODO no handle
  PL::gSound->Mixer.AddTask(CreateFunctor(&DynamicsProcessor::SetReleaseMSec, &CompressorObjectThreaded,
    milliseconds), nullptr);
}
...
void TagObject::SetCompressorRatio(float ratio)
{
  ...
  // TODO no handle
  PL::gSound->Mixer.AddTask(CreateFunctor(&DynamicsProcessor::SetRatio, &CompressorObjectThreaded,
    ratio), nullptr);
}
...
void TagObject::SetCompressorKneeWidth(float knee)
{
  ...
  // TODO no handle
  PL::gSound->Mixer.AddTask(CreateFunctor(&DynamicsProcessor::SetKneeWidth, &CompressorObjectThreaded,
    knee), nullptr);
}
  ...
  float at2500Hz, float above5000Hz, float timeToInterpolate)
{
  if (mTagObject)
  {
    ...
    PL::gSound->Mixer.AddTask(CreateFunctor(&TagObject::InterpolateEQBandsThreaded, *mTagObject,
