...
public:
  ...
  void Set(T value, AudioThreads::Enum threadCalledOn)
  {
    ...
    if (threadCalledOn == AudioThreads::MainThread)
      PL::gSound->Mixer.AddTask(CreateFunctor(&mValues[AudioThreads::MixThread], value), nullptr);
    else
      PL::gSound->Mixer.AddTaskThreaded(CreateFunctor(&mValues[AudioThreads::MainThread], value), nullptr);
  }
