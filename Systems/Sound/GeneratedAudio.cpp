...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&GeneratedWaveNode::InterpolateFrequencyThreaded, this,
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&GeneratedWaveNode::InterpolateVolumeThreaded, this,
...
void GeneratedWaveNode::SetSquareWavePulseValue(float value)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&Oscillator::SetSquareWavePositiveFraction, &WaveDataThreaded,
  ...
  SynthWaveType::Enum type)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&AdditiveSynthNode::AddHarmonicThreaded, this,
...
void AdditiveSynthNode::NoteOn(float midiNote, float volume)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&AdditiveSynthNode::NoteOnThreaded, this, (int)midiNote,
    volume), this);
}
...
void MicrophoneInputNode::SetVolume(float volume)
{
  ...
  if (mActive.Get(AudioThreads::MainThread) && mStopping.Get() == cFalse)
    PL::gSound->Mixer.AddTask(CreateFunctor(&InterpolatingObject::SetValues, &VolumeInterpolatorThreaded,
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&GranularSynthNode::SetSoundThreaded, this, sound,
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&GranularSynthNode::SetGrainLengthThreaded, this,
    lengthMS), this);
}
