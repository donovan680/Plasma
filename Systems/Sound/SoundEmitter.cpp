...
LightningDefineType(SoundEmitter, builder, type)
{
  ...
  LightningBindGetterSetterProperty(EmitAngle)->Add(new EditorSlider(0.0f, 360.0f, 1.0f))->
    PlasmaFilterBool(mDirectional);
  LightningBindGetterSetterProperty(RearVolume)->Add(new EditorSlider(0.0f, 1.0f, 0.1f))->
    PlasmaFilterBool(mDirectional);
...
void SoundEmitter::SetEmitAngle(float angleInDegrees)
{
  ...
  EmitterNode* node = mEmitterObject;
  PL::gSound->Mixer.AddTask(CreateFunctor(&EmitterNode::SetDirectionalAngleThreaded, node,
...
void SoundEmitter::Update(float dt)
{
  ...
  if (velocity != Vec3(0, 0, 0))
  {
    ...
    PL::gSound->Mixer.AddTask(CreateFunctor(&EmitterNode::SetPositionThreaded, node,
  ...
  if (mDirectional)
  {
    ...
    PL::gSound->Mixer.AddTask(CreateFunctor(&EmitterNode::SetForwardDirectionThreaded, node,
      forward), node);
  }
