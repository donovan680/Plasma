...
LightningDefineType(SoundCue, builder, type)
{
  ...
  LightningBindGetterSetterProperty(VolumeVariation)->Add(new EditorSlider(0.0f, 1.0f, 0.01f))->
    PlasmaFilterNotBool(mUseDecibelVariation);
  LightningBindGetterSetterProperty(DecibelVariation)->Add(new EditorSlider(0.0f, 6.0f, 0.1f))->
  ...
  LightningBindGetterSetterProperty(PitchVariation)->Add(new EditorSlider(0.0f, 1.0f, 0.1f))->
    PlasmaFilterNotBool(mUseSemitoneVariation);
  LightningBindGetterSetterProperty(SemitoneVariation)->Add(new EditorSlider(0.0f, 12.0f, 0.1f))->
