...
public:
  ...
  static unsigned OpenAndReadHeader(Plasma::Status& status, const String& fileName,
...
{
public:
  DecompressedDecoder(Plasma::Status& status, const Plasma::String& fileName, FileDecoderCallback callback,
    void* callbackData);
  ~DecompressedDecoder();
...
public:
  ...
  StreamingDecoder(Plasma::Status& status, Plasma::File* inputFile, Plasma::ThreadLock* lock,
  ...
  StreamingDecoder(Plasma::Status& status, byte* inputData, unsigned dataSize, unsigned channels,
