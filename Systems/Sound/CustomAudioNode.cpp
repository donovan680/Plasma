...
void CustomAudioNode::SendBuffer(SoundBuffer* buffer)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&CustomAudioNode::AddBufferThreaded, this, 
  ...
  ListenerNode* listener, const bool firstRequest)
{
  ...
  if (mBufferListThreaded.Empty())
  {
    if (!mWaitingForSamplesThreaded)
    {
      ...
      PL::gSound->Mixer.AddTaskThreaded(CreateFunctor(&CustomAudioNode::DispatchSamplesEvent, this,
...
void CustomAudioNode::SetMinimumBufferSize()
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&CustomAudioNode::mMinimumSamplesNeededInBuffersThreaded,
