    ...
    !outputRange.Empty(); )
  {
    ...
    if (CurrentData.mInterpolating)
    {
      ...
      if (CurrentData.mIndex >= Interpolator.GetTotalFrames())
      {
        ...
        if (firstRequest)
        {
          PL::gSound->Mixer.AddTaskThreaded(CreateFunctor(&SoundNode::DispatchEventFromMixThread, (SoundNode*)this,
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&PanningNode::SetVolumeThreaded, this, true,
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&PanningNode::SetVolumeThreaded, this, false,
    Math::Clamp(volume, 0.0f, cMaxVolumeValue), Math::Max(time, 0.0f)), this);
}
    ...
    for (unsigned currentFrame = 0; currentFrame < totalFrames; ++currentFrame)
    {
      ...
      if (CurrentData.mInterpolating)
      {
        ...
        if (LeftInterpolator.Finished() && RightInterpolator.Finished())
        {
          CurrentData.mInterpolating = false;
          if (firstRequest)
            PL::gSound->Mixer.AddTaskThreaded(CreateFunctor(&SoundNode::DispatchEventFromMixThread,
...
{
  pitchRatio = Math::Clamp(pitchRatio, cMinPitchValue, cMaxPitchValue);
  PL::gSound->Mixer.AddTask(CreateFunctor(&PitchNode::SetPitchThreaded, this, 
...
void EqualizerNode::SetLowPassGain(float gain)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&EqualizerNode::SetBandGainThreaded, this,
  ...
  float highPass, float timeToInterpolate)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&EqualizerNode::InterpolateAllThreaded, this, values,
...
{
  PL::gSound->Mixer.AddTask(CreateFunctor(&DelayNode::InterpolateWetValueThreaded, this, 
...
void AddNoiseNode::SetAdditiveGain(float decibels)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&AddNoiseNode::mAddGainThreaded, this,
...
void AddNoiseNode::SetMultiplicativeGain(float decibels)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&AddNoiseNode::mMultiplyGainThreaded, this,
...
void AddNoiseNode::SetAdditiveCutoff(float frequency)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&AddNoiseNode::mAddPeriodThreaded, this,
...
void AddNoiseNode::SetMultiplicativeCutoff(float frequency)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&AddNoiseNode::mMultiplyPeriodThreaded, this,
...
void ModulationNode::SetUseAmplitudeModulation(bool useAmplitude)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&ModulationNode::SetUseAmplitudeThreaded, this, useAmplitude),
    this);
}
...
void ModulationNode::SetFrequency(float frequency)
{
  ...
  PL::gSound->Mixer.AddTask(CreateFunctor(&ModulationNode::SetFrequencyThreaded, this,
