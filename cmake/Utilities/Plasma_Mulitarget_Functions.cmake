...
################################################################################
include(${cmake_utilities_dir}/plasma_target_precompiled_headers.cmake)
...
function(plasma_multitarget_compile_options)
    set(oneValueArgs )
...
function(plasma_multitarget_output_settings)
    ...
    foreach(target ${PARSED_TARGETS})
        ...
        if (NOT ("${PARSED_PRECOMPILED_HEADER_NAME}" STREQUAL ""))
            plasma_target_precompiled_headers(${target} "${intOutputDirectory}" ${PARSED_PRECOMPILED_HEADER_NAME} ${PARSED_PRECOMPILED_SOURCE_NAME} "${PARSED_TARGET_SUBFOLDER}" ${PARSED_IGNORE_TARGET})
        else()
...
#### Sets the output directories for intermediate files
function(plasma_multitarget_output_directories)
...
function(plasma_multitarget_copy_folders_to_target_output_directories)
