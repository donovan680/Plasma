...
function(plasma_target_precompiled_headers aTarget aIntPath aHeaderName aSourceName aSubFolder aIgnoreTarget)
  ...
  if (${MSVC} OR (CMAKE_GENERATOR_TOOLSET STREQUAL "LLVM-vs2014"))
    ...
    message(SEND_ERROR "plasma_target_precompiled_headers doesn't currently support anything but MSVC.")
  endif()
