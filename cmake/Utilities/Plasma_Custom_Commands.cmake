...
function (copy_cef_bin_post_build aTarget aPlasmaCoreDirectory aBuildOutputDirectory)
    add_custom_command(TARGET ${aTarget} POST_BUILD
...
function(editor_post_build_step aTarget aPlasmaCoreDirectory aLibOutputDirectory aBuildOutputDirectory aOS aPlatformShortName)
    set(pluginDir "${aPlasmaCoreDirectory}/Data/LightningCustomPluginShared/${aOS}-${aPlatformShortName}")
    ...
    #     COMMAND ${CMAKE_COMMAND} -E copy_if_different  
    #     # input file
    #     ${aPlasmaCoreDirectory}/Projects/Win32Shared/ErrorDialog.exe
    #     #output file
    ...
    add_custom_command(TARGET ${aTarget} POST_BUILD
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_if_different  
        # input file
        ${aPlasmaCoreDirectory}/Data/Configuration.data
        #output file
...
function(processor_post_build)
    # parse arguments
    set(oneValueArgs PLASMA_CORE_DIR PROCESSOR_OUTPUT_LOCATION CONFIGURATION)
    set(multiValueArgs SHARED_OBJECT_LOCATIONS)
    ...
    set(toolDir "${PARSED_PLASMA_CORE_DIR}/Tools/${PARSED_TARGETS}/${PARSED_CONFIGURATION}")
...
function(copy_launcher_files aTarget aPlasmaCoreDirectory aBuildOutputDirectory)
    ...
    COMMAND ${CMAKE_COMMAND} -E copy_if_different  
    # input file
    ${aPlasmaCoreDirectory}/Data/DefaultLauncherConfiguration.data
    #output file
...
function(launcher_shared_post_build aTarget aPlasmaCoreDirectory aProjectDirectory aBuildOutputDirectory)
    copy_launcher_files(${aTarget} ${aPlasmaCoreDirectory} ${aBuildOutputDirectory})
...
#### Copies launcher files to output directory then calls the create_build_info custom command for PlasmaLauncher
function(launcher_post_build aTarget aPlasmaCoreDirectory aProjectDirectory aBuildOutputDirectory)
    copy_launcher_files(${aTarget} ${aPlasmaCoreDirectory} ${aBuildOutputDirectory})
