...
function(plasma_source_group aRoot aTarget aSharedPath) 
...
function(plasma_subfolder_source_group aRoot restOfPath aTarget aSharedPath)
  set(pathToUse ${aRoot}/${restOfPath}/${aTarget})
  plasma_source_group(${pathToUse} ${aTarget} "${aSharedPath}")
  unset(pathToUse)
endfunction()

function(plasma_subfolder_source_group_ignore_target_folder aRoot restOfPath aTarget aSharedPath)
