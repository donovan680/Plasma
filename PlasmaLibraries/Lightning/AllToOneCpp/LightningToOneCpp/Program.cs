	...
	class Program
	{
		static int Main(string[] args)
		{
			...
			if (args.Length == 3 || args.Length == 4)
			{
				...
				if (forPlasma)
					lightningPath = Path.Combine(directoryPath, @"PlasmaLibraries\Lightning");
				...
				if (forPlasma)
					standardLibraries = Path.Combine(plasmaPath, @"PlasmaLibraries");
		...
		static void CompileLib(String vsVersion, String vsYear, String chipset, String configuration, String runtime, String arguments)
		{
			...
			compiler.StandardInput.WriteLine(@"""C:\Program Files (x86)\Microsoft Visual Studio " + vsVersion + @".0\VC\bin\" + pathIf64 + @"cl""  /c /Zi /nologo /W4 /WX " + arguments + @" /" + runtime + @" /Gm- /GS /Gy /fp:fast /Gd /Fd""C:\LightningBuildOutput\Distribution\" + fileName + @".pdb"" /Fa""C:\LightningBuildOutput\DistributionOut\\"" /Fo""C:\LightningBuildOutput\DistributionOut\" + fileName + @".obj"" ""C:\Sandbox\Plasma2\Lightning\Project\LightningAll\Lightning.cpp""");
