...
#define LightningDeclareStaticLibraryInternals(Name, Namespace, ...)    \
    ...
    Name() :                                                          \
    LL::StaticLibrary(#Name, Namespace)                               \
    {                                                                 \
      LightningDependency(LL::Core)                                       \
      __VA_ARGS__                                                     \
    }                                                                 \
    ...
    static LL::LibraryRef GetLibrary()                                \
    {                                                                 \
      return GetInstance().StaticLibrary::GetLibrary();               \
    }                                                                 \
    static LL::LibraryBuilder* GetBuilder()                           \
    {                                                                 \
    ...
    void SetupBinding(LL::LibraryBuilder& builder) override;
  ...
  #define LightningDeclareStaticLibrary(Name, Namespace, Linkage, ...)              \
    class Linkage Name : public LL::StaticLibrary                               \
    {                                                                           \
    public:                                                                     \
  ...
  #define LightningNoNamespace LL::String()
  ...
  #define LightningDefineStaticLibrary(Name)                                        \
    ...
    void Name::SetupBinding(LL::LibraryBuilder& builder)
