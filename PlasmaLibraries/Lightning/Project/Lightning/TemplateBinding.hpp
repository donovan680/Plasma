...
namespace Lightning
{
  ...
  #define LightningFullBindMethod(LightningBuilder, LightningType, MethodPointer, OverloadResolution, Name, SpaceDelimitedParameterNames) \
    LL::TemplateBinding::FromMethod<decltype(OverloadResolution MethodPointer), MethodPointer>(LightningBuilder, LightningType, Name, SpaceDelimitedParameterNames, OverloadResolution(MethodPointer))
  ...
  #define LightningFullBindVirtualMethod(LightningBuilder, LightningType, MethodPointer, NameOrNull) \
    LL::TemplateBinding::FromVirtual<decltype(MethodPointer), MethodPointer>(LightningBuilder, LightningType, Name, SpaceDelimitedParameterNames, (MethodPointer))
  ...
  #define LightningFullBindConstructor(LightningBuilder, LightningType, Class, SpaceDelimitedParameterNames, ...) \
    LL::TemplateBinding::FromConstructor<Class, ##__VA_ARGS__>(LightningBuilder, LightningType, SpaceDelimitedParameterNames)
  ...
  #define LightningFullBindConstructorVirtual(LightningBuilder, LightningType, Class, SpaceDelimitedParameterNames, ...) \
    LL::TemplateBinding::FromConstructorVirtual<Class, ##__VA_ARGS__>(LightningBuilder, LightningType, SpaceDelimitedParameterNames)
  ...
  #define LightningFullBindDestructor(LightningBuilder, LightningType, Class) \
    LL::TemplateBinding::FromDestructor<Class >(LightningBuilder, LightningType)
  ...
  #define LightningFullBindField(LightningBuilder, LightningType, FieldPointer, Name, PropertyBinding) \
    LL::TemplateBinding::FromField<decltype(FieldPointer), FieldPointer>(LightningBuilder, LightningType, Name, FieldPointer, PropertyBinding)
  ...
  #define LightningFullBindGetterSetter(LightningBuilder, LightningType, GetterMethodPointer, GetterOverload, SetterMethodPointer, SetterOverload, Name) \
    LL::TemplateBinding::FromGetterSetter<decltype(GetterOverload GetterMethodPointer), GetterMethodPointer, decltype(SetterOverload SetterMethodPointer), SetterMethodPointer>(LightningBuilder, LightningType, Name, GetterMethodPointer, SetterMethodPointer)
  ...
  #define LightningFullBindEnum(LightningBuilder, LightningType, SpecialTypeEnum)                                                         \
    ...
    {                                                                                                                         \
      ...
      if ((SpecialTypeEnum) == LL::SpecialType::Enumeration)                                                                  \
        (LightningType)->ToStringFunction = LL::VirtualMachine::EnumerationToString;                                              \
      else                                                                                                                    \
        (LightningType)->ToStringFunction = LL::VirtualMachine::FlagsToString;                                                    \
      ErrorIf((LightningType)->Size != sizeof(LL::Integer), "The sizeof(Enum) bound to Lightning must match the sizeof(Integer)");    \
      (LightningType)->BaseType = LightningTypeId(LL::Enum);                                                                          \
    }                                                                                                                         \
    while(false)
