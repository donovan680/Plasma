...
namespace Lightning
{
  ...
  #define LightningAllocate(T, ...) (LL::ExecutableState::GetCallingState()->AllocateDefaultConstructed<T>(__VA_ARGS__))
  #define LightningAllocateUntyped(...) (LL::ExecutableState::GetCallingState()->AllocateDefaultConstructedHeapObject(__VA_ARGS__))
