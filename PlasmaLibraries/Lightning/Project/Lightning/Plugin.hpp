...
namespace Lightning
{
  ...
  #define LightningDeclareStaticLibraryAndPlugin(LibraryName, PluginName, ...)                          \
    ...
    class PluginName : public LL::Plugin                                                            \
    {                                                                                               \
    public:                                                                                         \
      ~PluginName() override;                                                                       \
      void PreBuild(LL::BuildEvent* event) override;                                                \
      LL::LibraryRef GetLibrary() override;                                                         \
  ...
  #define LightningDefineStaticLibraryAndPlugin(LibraryName, PluginName, ...)                           \
    ...
    void PluginName::PreBuild(LL::BuildEvent* event)                                                \
    {                                                                                               \
      __VA_ARGS__;                                                                                  \
      if (LibraryName::Instance == nullptr)                                                         \
        LibraryName::InitializeInstance();                                                          \
      LL::LibraryRef library = LibraryName::GetInstance().GetLibrary();                             \
      library->UserData = this->UserData;                                                           \
    }                                                                                               \
    LL::LibraryRef PluginName::GetLibrary()                                                         \
    {                                                                                               \
