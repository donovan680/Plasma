...
#define PlasmaBindSerializationPrimitiveExternal(type) LightningTypeId(type)->AddAttribute(SerializationAttributes::cSerializationPrimitive)
...
public:
  ...
  // The default serialize object assumes that the value inherits from Plasma's Object class
...
#define PlasmaSerialize(DefaultValue) AddAttributeChainable(PropertyAttributes::cSerialize)->Add(new MetaSerializedProperty(DefaultValue))
