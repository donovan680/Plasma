...
//**************************************************************************************************
void BuildOrthographicTransformPlasma(Mat4& matrix, float verticalSize, float aspectRatio, float nearDistance, float farDistance)
{
...
//**************************************************************************************************
void BuildPerspectiveTransformPlasma(Mat4& matrix, float verticalFov, float aspectRatio, float nearDistance, float farDistance)
{
  // Plasma maps NDC [-1,-1,-1] to [1,1,1] ([l,b,n] to [r,t,f])
