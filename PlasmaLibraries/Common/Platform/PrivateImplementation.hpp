...
#define PlasmaDeclarePrivateDataBytes(SizeInBytes)                                                 \
...
#define PlasmaGetObjectPrivateData(Type, pointer, name) \
  Type* name = (Type*)(pointer)->mPrivateData;

#define PlasmaGetPrivateData(Type) \
...
#define PlasmaDestructPrivateData(Type, ...)  \
