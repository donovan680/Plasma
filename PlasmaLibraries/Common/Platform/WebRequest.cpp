...
{
  static const String cBoundary("----------PlasmaEngine43476095-a5a0-4190-a9b5-bce2d2de5eef$");
  return cBoundary;
}
...
String WebRequest::GetPlasmaUserAgent()
{
  ...
  return "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36 Edge/12.0 Plasma";
}
