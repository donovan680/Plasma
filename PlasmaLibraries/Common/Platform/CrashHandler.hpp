...
struct CrashInfo
{
  CrashInfo()
  {
    mDumpName = "PlasmaDump.dmp";
    mLogName = "PlasmaLog.txt";
    mStackName = "PlasmaStack.txt";
    mModuleName = "PlasmaEditor";
    mStripModules = false;
  }
...
struct CrashHandler
{
  ...
  // Used currently to put Lightning op-code into the dump for debugging.
