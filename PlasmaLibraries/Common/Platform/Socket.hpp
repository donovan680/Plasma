...
PlasmaShared SocketAddress ResolveSocketAddress(Status& status, StringParam host, StringParam service, SocketAddressFamily::Enum addressFamily,
...
PlasmaShared SocketAddress ResolveSocketAddress(Status& status, StringParam host, StringParam service, SocketAddressResolutionFlags::Enum addressResolutionFlags);
...
/// Note: Preferred socket address order is documented in RFC 3484
/// (Named getaddrinfo on most platforms)
PlasmaShared Array<SocketAddress> ResolveAllSocketAddresses(Status& status, StringParam host, StringParam service, SocketAddressFamily::Enum addressFamily,
                                                          SocketProtocol::Enum protocol, SocketType::Enum type, SocketAddressResolutionFlags::Enum addressResolutionFlags);
PlasmaShared Array<SocketAddress> ResolveAllSocketAddresses(Status& status, StringParam host, StringParam service, SocketAddressFamily::Enum addressFamily,
                                                          SocketProtocol::Enum protocol, SocketAddressResolutionFlags::Enum addressResolutionFlags);
PlasmaShared Array<SocketAddress> ResolveAllSocketAddresses(Status& status, StringParam host, StringParam service, SocketAddressFamily::Enum addressFamily,
                                                          SocketAddressResolutionFlags::Enum addressResolutionFlags);
PlasmaShared Array<SocketAddress> ResolveAllSocketAddresses(Status& status, StringParam host, StringParam service, SocketAddressResolutionFlags::Enum addressResolutionFlags);
...
PlasmaShared Pair<String, String> ResolveHostAndServiceNames(Status& status, const SocketAddress& address, SocketNameResolutionFlags::Enum nameResolutionFlags);
...
PlasmaShared String SocketAddressToString(Status& status, SocketAddressFamily::Enum addressFamily, const SocketAddress& address);
...
PlasmaShared SocketAddress StringToSocketAddress(Status& status, SocketAddressFamily::Enum addressFamily, StringParam address);
