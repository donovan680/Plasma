...
#define forRangeRef(value, rangeExpr) PlasmaForRangeReferenceHelper(value, __rangeT, (rangeExpr).All(), __rangeT.PopFront(), )
...
#define PlasmaForRangeVar(value, rangeName, rangeExpr) PlasmaForRangeHelper(value, rangeName, (rangeExpr).All(), VoidReturn(), if(PopFront(rangeName)))
#define PlasmaForRangeRefVar(value, rangeName, rangeExpr) PlasmaForRangeReferenceHelper(value, rangeName, (rangeExpr).All(), VoidReturn(), if(PopFront(rangeName)))
