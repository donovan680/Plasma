...
/// During variant default assignment, stored types without a default constructor will be plasma-initialized instead.
/// Note: plasma-initialized is likely not a valid state for complex types! Highly recommended to keep this assert enabled.
