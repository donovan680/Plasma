...
PlasmaSharedTemplate DestructObjectFn GetDestructObjectFn() { return DestructObject<T>; }
template <typename T, TF_DISABLE_IF(has_destructor<T>::value)>
PlasmaSharedTemplate DestructObjectFn GetDestructObjectFn() { return nullptr; }
...
PlasmaSharedTemplate DefaultConstructObjectFn GetDefaultConstructObjectFn() { return DefaultConstructObject<T>; }
template <typename T, TF_DISABLE_IF(has_default_constructor<T>::value)>
PlasmaSharedTemplate DefaultConstructObjectFn GetDefaultConstructObjectFn() { return nullptr; }
...
PlasmaSharedTemplate CopyConstructObjectFn GetCopyConstructObjectFn() { return CopyConstructObject<T>; }
template <typename T, TF_DISABLE_IF(has_copy_constructor<T>::value)>
PlasmaSharedTemplate CopyConstructObjectFn GetCopyConstructObjectFn() { return nullptr; }
...
PlasmaSharedTemplate MoveConstructObjectFn GetMoveConstructObjectFn() { return MoveConstructObject<T>; }
template <typename T, TF_DISABLE_IF(has_move_constructor<T>::value)>
PlasmaSharedTemplate MoveConstructObjectFn GetMoveConstructObjectFn() { return nullptr; }
...
PlasmaSharedTemplate EqualToObjectFn GetEqualToObjectFn() { return EqualToObject<T>; }
template <typename T, TF_DISABLE_IF(has_valid_compare_policy<T>::value)>
PlasmaSharedTemplate EqualToObjectFn GetEqualToObjectFn() { return nullptr; }
...
PlasmaSharedTemplate HashObjectFn GetHashObjectFn() { return HashObject<T>; }
template <typename T, TF_DISABLE_IF(has_valid_hash_policy<T>::value)>
PlasmaSharedTemplate HashObjectFn GetHashObjectFn() { return nullptr; }
...
PlasmaSharedTemplate ObjectToStringFn GetObjectToStringFn() { return ObjectToString<T>; }
template <typename T, TF_DISABLE_IF(has_global_to_string<T>::value)>
PlasmaSharedTemplate ObjectToStringFn GetObjectToStringFn() { return nullptr; }
...
PlasmaSharedTemplate StringToObjectFn GetStringToObjectFn() { return StringToObject<T>; }
template <typename T, TF_DISABLE_IF(has_global_to_value<T>::value)>
PlasmaSharedTemplate StringToObjectFn GetStringToObjectFn() { return nullptr; }
