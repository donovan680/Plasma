...
#define PlasmaVSPrintf(destination, bufferSizeBytes, format, args) \
...
#define PlasmaStrCat(destination, bufferSizeBytes, source) \
  strcat_s(destination, bufferSizeBytes, source)

#define PlasmaStrCatW(destination, bufferSizeBytes, source) \
  wcscat_s(destination, bufferSizeBytes, source)

#define PlasmaStrCpy(destination, bufferSizeBytes, source) \
  strcpy_s(destination, bufferSizeBytes, source)

#define PlasmaStrCpyW(destination, bufferSizeBytes, source) \
  wcscpy_s(destination, bufferSizeBytes, source)

#define PlasmaCStringCopy(dest, destSize, source, sourceSize) \
