...
{
  // Invoke user-defined function
  return Plasma::SerializeQuantized(SerializeDirection::Write, *this, const_cast<T&>(value_), minValue_, maxValue_, quantum_);
}
...
{
  // Invoke user-defined function
  return Plasma::SerializeQuantized(SerializeDirection::Read, *const_cast<BitStream*>(this), value_, minValue_, maxValue_, quantum_);
}
