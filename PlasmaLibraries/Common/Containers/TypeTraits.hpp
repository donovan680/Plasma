...
#define PlasmaDeclareHasMemberTrait(TypeTraitName, MemberName)                                                    \
  template <typename LightningT> static ::Plasma::true_type  check_##TypeTraitName(decltype(&LightningT::MemberName)*);   \
  template <typename LightningT> static ::Plasma::false_type check_##TypeTraitName(...);                              \
  template <typename LightningT> struct TypeTraitName : public decltype(check_##TypeTraitName<LightningT>(nullptr)) {};
...
#define TF_ENABLE_IF(Condition)             typename Plasma::enable_if<(Condition)>::type* = (void*)nullptr
#define TF_ENABLE_IF_IS_SAME(TypeA, TypeB)  typename Plasma::enable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type* = (void*)nullptr
#define TF_DISABLE_IF(Condition)            typename Plasma::disable_if<(Condition)>::type* = (void*)nullptr
#define TF_DISABLE_IF_IS_SAME(TypeA, TypeB) typename Plasma::disable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type* = (void*)nullptr
...
#define P_ENABLE_IF(Condition)             typename Plasma::enable_if<(Condition)>::type* = (void*)nullptr
#define P_ENABLE_IF_IS_SAME(TypeA, TypeB)  typename Plasma::enable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type* = (void*)nullptr
#define P_DISABLE_IF(Condition)            typename Plasma::disable_if<(Condition)>::type* = (void*)nullptr
#define P_DISABLE_IF_IS_SAME(TypeA, TypeB) typename Plasma::disable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type* = (void*)nullptr
