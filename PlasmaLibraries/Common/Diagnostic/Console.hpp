...
#define ZPrintFilter(filter, ...) ::Plasma::Console::Print(filter, __VA_ARGS__)
#define ZPrint(...) ::Plasma::Console::Print(Plasma::Filter::DefaultFilter, __VA_ARGS__)
...
#define DebugTrace(format, ...) ::Plasma::Console::Print(Plasma::Filter::DefaultFilter, "%s(%d) : " format , __FILE__ , __LINE__, __VA_ARGS__)
