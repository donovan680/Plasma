...
LightningDefineExternalBaseType(IpAddress, TypeCopyMode::ReferenceType, builder, type)
{
  ...
  LightningFullBindGetterSetter(builder, type,
    &Plasma::IpAddress::GetHost, (String(Plasma::IpAddress::*)() const),
    &Plasma::IpAddress::SetHost, (void(Plasma::IpAddress::*)(StringParam)),
    "Host");
  LightningFullBindGetterSetter(builder, type,
    &Plasma::IpAddress::GetPort, (uint(Plasma::IpAddress::*)() const),
    &Plasma::IpAddress::SetPort, (void(Plasma::IpAddress::*)(uint)),
    "Port");
