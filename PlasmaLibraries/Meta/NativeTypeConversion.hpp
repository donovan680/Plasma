...
/// Returns the basic native type corresponding to the specified lightning type (may be null), else nullptr
NativeType* LightningTypeToBasicNativeType(Lightning::Type* lightningType);

/// Returns the lightning type corresponding to the specified basic native type (may be null), else nullptr
