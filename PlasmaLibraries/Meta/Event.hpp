                    ...
                    classType* receiver, void (classType::*function)(eventType*))
{
  ...
  ErrorIf(type->IsInitialized() == false,
    "The event type was never initialized using LightningDeclareType / LightningDefineType / LightningInitializeType");
...
#define ConnectThisTo(target, eventname, handle) \
  do { Plasma::Connect(target, eventname, this, &LightningSelf::handle); } while (false)
