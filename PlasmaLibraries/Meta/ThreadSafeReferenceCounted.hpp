...
#define ConstructThreadSafeReferenceCountedHandle()                                                                      \
  ErrorIf(LightningVirtualTypeId(this)->HandleManager != LightningManagerId(ThreadSafeReferenceCountedHandleManager<LightningSelf>), \
    "Set type->HandleManager = LightningManagerId(ThreadSafeReferenceCountedHandleManager<LightningSelf>; in binding");          \
  mLock.Lock();                                                                                                          \
...
#define PlasmaRegisterThreadSafeReferenceCountedHandleManager(type) LightningRegisterSharedHandleManager(ThreadSafeReferenceCountedHandleManager<type>);
