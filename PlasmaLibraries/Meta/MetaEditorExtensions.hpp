...
#define PlasmaFilterBool(Member)                                      \
  Add(new MetaPropertyBasicFilter(new TemplateFilterBool<LightningSelf, &LightningSelf::Member>()))
...
#define PlasmaFilterEquality(Member, MemberType, ConstantValue)       \
  Add(new MetaPropertyBasicFilter(new TemplateFilterEquality<LightningSelf, MemberType, &LightningSelf::Member, ConstantValue>()))
