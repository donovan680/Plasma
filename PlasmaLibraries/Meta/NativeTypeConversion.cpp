...
Lightning::Type* BasicNativeTypeToLightningType(NativeTypeId nativeTypeId)
{
  ...
  case BasicNativeType::Int64:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::Int64>::Type); // DoubleInteger type
  ...
  case BasicNativeType::Double:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::Double>::Type); // DoubleReal type

  // Multi-Primitive Math Types
  case BasicNativeType::BoolVector2:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::BoolVector2>::Type); // Boolean2 type
  case BasicNativeType::BoolVector3:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::BoolVector3>::Type); // Boolean3 type
  case BasicNativeType::BoolVector4:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::BoolVector4>::Type); // Boolean4 type
  case BasicNativeType::IntVector2:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::IntVector2>::Type); // Integer2 type
  case BasicNativeType::IntVector3:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::IntVector3>::Type); // Integer3 type
  case BasicNativeType::IntVector4:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::IntVector4>::Type); // Integer4 type
  ...
  case BasicNativeType::Quaternion:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::Quaternion>::Type); // Quaternion type
  case BasicNativeType::Matrix3:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::Matrix3>::Type); // Real3x3 type
  case BasicNativeType::Matrix4:
    return LightningTypeId(BasicNativeTypeFromEnum<BasicNativeType::Matrix4>::Type); // Real4x4 type
...
Any ConvertBasicVariantToAny(const Variant& variantValue)
{
  ...
  if(!lightningType) // Unable? (The variant's stored type is not a basic native type?)
    return Any();
