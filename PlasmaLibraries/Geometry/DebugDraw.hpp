...
public:
  ...
  Capsule(const Plasma::Capsule& capsule)
...
public:
  ...
  Cylinder(const Plasma::Cylinder& cylinder)
...
public:
  ...
  Line(const Plasma::Ray& ray, float t = 1.0f)
    : mStart(ray.Start), mEnd(ray.Start + ray.Direction * t), mHeadSize(1.0f) {}

  Line(const Plasma::Segment& segment)
...
public:
  ...
  Sphere(const Plasma::Sphere& sphere)
...
public:
  ...
  Triangle(const Plasma::Triangle& tri)
