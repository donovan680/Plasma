...
void DrawPoint(Vec2Param point, const ByteColor& color)
{
  ...
  Plasma::gDebugDraw->Add(Plasma::Debug::Circle(p, cCircleAxis, 
  ...
  Plasma::gDebugDraw->Add(Plasma::Debug::Line(circlePoints[0], 
                                       circlePoints[1]).Color(color)
                                                       .OnTop(true));
  Plasma::gDebugDraw->Add(Plasma::Debug::Line(circlePoints[2],
...
void Hull2D::Draw(void) const
{
  ...
  for(uint i = 0; i < pointCount; ++i)
  {
    ...
    Plasma::gDebugDraw->Add(Plasma::Debug::Line(thisPoint, nextPoint).Color(color)
                                                              .OnTop(true));
  }
  ...
  if(mUsingDebug)
  {
    ...
    Plasma::gDebugDraw->Add(Plasma::Debug::Line(start, end).Color(Color::Yellow)
                                                    .OnTop(true));
