...
bool SetGamepadVibration(size_t gamepadIndex, float leftSpeed, float rightSpeed)
{
  ...
  vibration.wLeftMotorSpeed = (WORD)(leftSpeed * MaxRumble);
  vibration.wRightMotorSpeed = (WORD)(rightSpeed * MaxRumble);
  return (*XInputSetState_P)(gamepadIndex, &vibration) == ERROR_SUCCESS;
}
