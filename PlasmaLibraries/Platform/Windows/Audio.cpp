...
{
  ZPrint(Plasma::String::Format(message.c_str(), "\n").c_str());
  if (savedMessage)
  ...
  Plasma::String* message)
{
    ...
    Format->wFormatTag != WAVE_FORMAT_IEEE_FLOAT))
  {
    ...
    LogAudioIoError(GetMessageForHresult(Plasma::String::Format("Incompatible audio format 0x%04x.", 
