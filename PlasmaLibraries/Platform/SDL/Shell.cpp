...
Keys::Enum SDLScancodeToKey(SDL_Scancode code)
{
  switch (code)
  {
#define ProcessInput(Scancode, Keycode, PlasmaValue) case Scancode: return PlasmaValue;
#include "Keys.inl"
#undef ProcessInput
  }
...
SDL_Scancode KeyToSDLScancode(Keys::Enum key)
{
  switch (key)
  {
#define ProcessInput(Scancode, Keycode, PlasmaValue) case PlasmaValue: return Scancode;
#include "Keys.inl"
#undef ProcessInput
  }
...
Keys::Enum SDLKeycodeToKey(SDL_Keycode code)
{
  switch (code)
  {
#define ProcessInput(Scancode, Keycode, PlasmaValue) case Keycode: return PlasmaValue;
#include "Keys.inl"
#undef ProcessInput
  }
...
SDL_Keycode KeyToSDLKeycode(Keys::Enum key)
{
  switch (key)
  {
#define ProcessInput(Scancode, Keycode, PlasmaValue) case PlasmaValue: return Keycode;
#include "Keys.inl"
#undef ProcessInput
  }
...
MouseButtons::Enum SDLToMouseButton(int button)
{
  switch (button)
  {
#define ProcessInput(VKValue, PlasmaValue) case VKValue: return PlasmaValue;
...
int MouseButtonToSDL(MouseButtons::Enum button)
{
  switch (button)
  {
#define ProcessInput(VKValue, PlasmaValue) case PlasmaValue: return VKValue;
#include "MouseButtons.inl"
#undef ProcessInput
  }
  return 0;
...
#if !defined(PlasmaPlatformNoShellIsClipboardText)
...
#if !defined(PlasmaPlatformNoShellGetClipboardText)
...
#if !defined(PlasmaPlatformNoShellSetClipboardText)
...
#if !defined(PlasmaPlatformNoShellIsClipboardImage)
...
#if !defined(PlasmaPlatformNoShellGetClipboardImage)
