...
typedef Plasma::StringRange StringRange;
typedef Plasma::String String;
...
{
  String path = Plasma::FilePath::Combine(str0, str1, str2);
...
{
  String path = Plasma::FilePath::CombineWithExtension(str0, str1, str2);
  CHECK_STRING_EQUAL(path.c_str(), String(expected).c_str());
}
...
{
  TestStringRange(dirPath        , Plasma::FilePath::GetDirectoryPath(fullPath));
  TestStringRange(dirName        , Plasma::FilePath::GetDirectoryName(fullPath));
  TestStringRange(fileNameWithExt, Plasma::FilePath::GetFileName(fullPath));
  TestStringRange(fileName       , Plasma::FilePath::GetFileNameWithoutExtension(fullPath));
  TestStringRange(ext            , Plasma::FilePath::GetExtension(fullPath));

  Plasma::FilePathInfo info = Plasma::FilePath::GetPathInfo(fullPath);
...
{
  String normalizedPath = Plasma::FilePath::Normalize(fullPath);
