...
void ErrorReporter::OnTranslationError(TranslationErrorEvent* errorEvent)
{
  ...
  errorMsg = errorEvent->mLocation.GetFormattedStringWithMessage(Lightning::MessageFormat::MsvcCpp, errorMsg);
  OnError(errorEvent->mLocation.Origin, errorMsg);
}

void ErrorReporter::OnCompilationError(Lightning::ErrorEvent* e)
{
  String errorMsg = BuildString(e->GetFormattedMessage(Lightning::MessageFormat::MsvcCpp), "\n");
