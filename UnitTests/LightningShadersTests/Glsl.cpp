...
GlslRenderer::GlslRenderer(void* context)
{
  ...
  mLightningFragmentTypeToGlsl.Insert(FragmentType::Vertex, GL_VERTEX_SHADER);
  mLightningFragmentTypeToGlsl.Insert(FragmentType::Geometry, GL_GEOMETRY_SHADER);
  mLightningFragmentTypeToGlsl.Insert(FragmentType::Pixel, GL_FRAGMENT_SHADER);
  mLightningFragmentTypeToGlsl.Insert(FragmentType::Compute, GL_COMPUTE_SHADER);
}
...
{
  int glslType = mLightningFragmentTypeToGlsl.FindValue(fragmentType, -1);
