...
struct BasicTests
{
  ...
  void Serialize(Plasma::Serializer& stream )
  {
    ...
    // METAREFACTOR
    //Plasma::EnumMap testEnumMap = Plasma::EnumMap(TestEnum::Names, TestEnum::Values);
...
typedef  FileBased<BasicTests, Plasma::TextSaver, Plasma::DataTreeLoader> BasicTextFileDataTree;
...
typedef  FileBased<BasicTests, Plasma::TextSaver, Plasma::DataTreeLoader> BasicTextFile;
...
//typedef  FileBased<BasicTests, Plasma::BinaryFileSaver, Plasma::BinaryFileLoader> BasicBinaryFile;
//
...
//}
//
//typedef  BufferBased<BasicTests, Plasma::BinaryBufferSaver, Plasma::BinaryBufferLoader> BasicBinaryBuffer;
//
