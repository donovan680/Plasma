...
public:
  void Run()
  {
...

    {
      ...
      saver.Start("TestObject", nullptr, Plasma::StructureType::Object);
      output.Serialize(saver);
      saver.End("TestObject", Plasma::StructureType::Object);
      saver.Close();
...

    {
      ...
      loader.Start("TestObject", nullptr, Plasma::StructureType::Object);
      readFromFile.Serialize(loader);
      loader.End("TestObject", Plasma::StructureType::Object);
