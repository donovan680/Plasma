...
PlasmaDefineType(RayTracedGraphicsProvider);
...
void RayTracedGraphicsProvider::InitializeMeta(MetaType* meta)
{
  ...
  LightningBindGetterSetterProperty(ShadowSamples);
  LightningBindGetterSetterProperty(PixelSamples);
  LightningBindGetterSetterProperty(AmbientColor);
  LightningBindGetterSetterProperty(AirAttenuation);
  LightningBindGetterSetterProperty(PixelSampleType);  //METAREFACTOR enum AntiAliasingType
