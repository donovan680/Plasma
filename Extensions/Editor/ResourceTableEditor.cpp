...
void ResourceWeightedTableView::CreateItem(StringParam name, StringParam value, float probability)
{
  ...
  Plasma::Connect(entry.mProbability, Events::TextBoxChanged, entry.mBar,
    &WeightedTableBar::OnProbabilityChanged);
  Plasma::Connect(entry.mNameTag, Events::TextBoxChanged, entry.mBar,
    &WeightedTableBar::OnNameChanged);
  Plasma::Connect(entry.mValueTag, Events::TextBoxChanged, entry.mBar,
