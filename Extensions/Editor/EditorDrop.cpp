...
bool DropOnObjectViewport(MetaDropEvent* event, Viewport* viewport, Space* space)
{
  ...
  if(SpriteSource* spriteSource = instance.Get<SpriteSource*>())
  {
    ...
    {
      Cog* object = PL::gEditor->Tools->mCreationTool->CreateWithViewport(viewport, dropPosition, CoreArchetypes::Sprite);
      if(object)
      {
  ...
  if(Mesh* mesh = instance.Get<Mesh*>())
  {
    ...
    {
      Cog* object = PL::gEditor->Tools->mCreationTool->CreateWithViewport(viewport, dropPosition, CoreArchetypes::Transform);
      if(object)
      {
