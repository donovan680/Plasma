...
void LibraryView::OnRightClickObject(Composite* objectToAttachTo, DataIndex index)
{
  ...
  if(resource)
  {
    ...
    {
      ConnectMenu(menu, "ComposeLightningMaterial", OnComposeLightningMaterial);
      ConnectMenu(menu, "TranslateLightningPixelMaterial", OnTranslateLightningPixelMaterial);
      ConnectMenu(menu, "TranslateLightningGeometryMaterial", OnTranslateLightningGeometryMaterial);
      ConnectMenu(menu, "TranslateLightningVertexMaterial", OnTranslateLightningVertexMaterial);
    }
...
void LibraryView::OpenTagEditor()
{
  ...
  seq->Add(AnimatePropertyGetSet(LightningSelf, TagEditorCurrentHeight, Ease::Quad::Out,
