  ...
  : Composite(parent), mCogCommandSortToggle(true), mCurrentSort(CommandCompare::None)
{
  ...
  {
    String userHotKeyFile = FilePath::Combine(GetUserDocumentsDirectory(), "PlasmaEditor", "Default.HotKeyDataSet.data");
...
void HotKeyEditor::OnMouseEnterIconHeader(MouseEvent* event)
{
  ...
  if(mCogCommandSortToggle)
    ...
    CreateCommandHeaderToolTip(source, "Plasma Commands", cPlasmaCommandColor);
}
