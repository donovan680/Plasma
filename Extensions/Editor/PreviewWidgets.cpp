  ...
  : PreviewWidget(initializer)
{
  ...
  uint creationFlags = CreationFlags::Editing | CreationFlags::Preview;
  Cog* camera = PL::gFactory->Create(space, CoreArchetypes::PreviewCamera, creationFlags, PL::gEditor->GetEditGameSession());
...
{
  //Space archetype
  Space* space =  PL::gFactory->CreateSpace(archetype->ResourceIdName, CreationFlags::Editing, PL::gEditor->GetEditGameSession());
  mObject = space;
}
  ...
  : IconPreview (initializer, "Level")
{
  ...
  {
    mObject = (GameSession*)PL::gFactory->CreateCheckedType(LightningTypeId(GameSession), nullptr, 
...
void RegisterEditorTileViewWidgets()
{
  ...
  previewFactory->Creators["LightningScript"] =       PreviewWidgetCreator(PreviewImportance::Simple, &CreatePreviewWidgetT<ScriptPreview>);
  previewFactory->Creators["LightningFragment"] =     PreviewWidgetCreator(PreviewImportance::Simple, &CreatePreviewWidgetT<ScriptPreview>);
  previewFactory->Creators["TextBlock"] =         PreviewWidgetCreator(PreviewImportance::Simple, &CreatePreviewWidgetT<ScriptPreview>);
  previewFactory->Creators["LightningPluginSource"] = PreviewWidgetCreator(PreviewImportance::Simple, &CreatePreviewWidgetT<ScriptPreview>);
