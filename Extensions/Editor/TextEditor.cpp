...
class ScintillaPlasma : public ScintillaBase
{
public:
...
static int KeyTranslate(int keyIn)
{
  switch (keyIn)
  {
  case Plasma::Keys::Down:      return SCK_DOWN;
  case Plasma::Keys::Up:        return SCK_UP;
  case Plasma::Keys::Left:      return SCK_LEFT;
  case Plasma::Keys::Right:     return SCK_RIGHT;
  case Plasma::Keys::Home:      return SCK_HOME;
  case Plasma::Keys::End:       return SCK_END;
  case Plasma::Keys::PageUp:    return SCK_PRIOR;
  case Plasma::Keys::PageDown:  return SCK_NEXT;
  case Plasma::Keys::Delete:    return SCK_DELETE;
  case Plasma::Keys::Escape:    return SCK_ESCAPE;
  case Plasma::Keys::Back:      return SCK_BACK;
  case Plasma::Keys::Tab:       return SCK_TAB;
  case Plasma::Keys::Enter:     return SCK_RETURN;
  case Plasma::Keys::Alt:       return SCK_MENU;
...
void ScintillaPlasma::MoveSelection(SelectionRange& selection, int pos, bool extend)
{
...
bool ScintillaPlasma::IsSelected(SelectionRange& range, int* endSelectionOut)
{
  for(size_t i = 0; i < sel.Count(); ++i)
  {
...
bool ScintillaPlasma::FindTextNotSelected(int start, int end, const char* text, SelectionRange& newSel)
{
...
void ScintillaPlasma::Copy()
{
  if(sel.Empty())
  {
    ...
    PL::gEngine->has(Plasma::OsShell)->SetClipboardText(StringRange(selectedText.s, selectedText.s + selectedText.len));
    return;
  }
  ...
  PL::gEngine->has(Plasma::OsShell)->SetClipboardText(text.All());
}
...
void ScintillaPlasma::Paste()
{
  ...
  Plasma::String clipboardText = PL::gEngine->has(Plasma::OsShell)->GetClipboardText();
...
void ScintillaPlasma::NotifyParent(SCNotification scn)
{
  mOwner->OnNotify(scn);
}
...
void ScintillaPlasma::CreateCallTipWindow(PRectangle rc)
{
}
...
void ScintillaPlasma::CopyToClipboard(const SelectionText &selectedText)
{
}

void ScintillaPlasma::NotifyDoubleClick(Point pt, bool shift, bool ctrl, bool alt)
{
}
