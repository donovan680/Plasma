...
private:
  void CreateImageAndSampler(LightningSpirVFrontEnd* translator, LightningShaderIRLibrary* shaderLibrary,
  ...
  void CreateStorageImage(LightningSpirVFrontEnd* translator, LightningShaderIRLibrary* shaderLibrary,
