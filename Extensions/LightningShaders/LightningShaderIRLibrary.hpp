...
typedef void(*DefaultConstructorResolverFn)(LightningSpirVFrontEnd* translator, Lightning::Type* resultType, LightningSpirVFrontEndContext* context);
typedef void(*ConstructorCallResolverIRFn)(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context);
typedef void(*MemberAccessResolverIRFn)(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context);
typedef void(*MemberFunctionResolverIRFn)(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context);
typedef void(*MemberPropertySetterResolverIRFn)(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningShaderIROp* resultValue, LightningSpirVFrontEndContext* context);
typedef void(*BinaryOpResolverIRFn)(LightningSpirVFrontEnd* translator, Lightning::BinaryOperatorNode* binaryOpNode, LightningSpirVFrontEndContext* context);
typedef void(*UnaryOpResolverIRFn)(LightningSpirVFrontEnd* translator, Lightning::UnaryOperatorNode* binaryOpNode, LightningSpirVFrontEndContext* context);
typedef void(*TypeCastResolverIRFn)(LightningSpirVFrontEnd* translator, Lightning::TypeCastNode* binaryOpNode, LightningSpirVFrontEndContext* context);
typedef void(*TemplateTypeIRResloverFn)(LightningSpirVFrontEnd* translator, Lightning::BoundType* boundType);
typedef void(*ExpressionInitializerIRResolverFn)(LightningSpirVFrontEnd* translator, Lightning::ExpressionInitializerNode*& node, LightningSpirVFrontEndContext* context);
...
{
  FragmentSharedKey();
  FragmentSharedKey(spv::StorageClass storageClass, LightningShaderIRType* fieldType, StringParam varName);
...
public:
  /// Binary operators
  void RegisterBinaryOpResolver(Lightning::Type* lhsType, Lightning::Type* rhsType, Lightning::Grammar::Enum op, BinaryOpResolverIRFn resolver);
...
public:
  ...
  LightningShaderExtensionImport* FindExtensionLibraryImport(SpirVExtensionLibrary* extensionLibrary, bool checkDependencies = true);
...
public:
  ...
  MemberAccessResolverIRFn FindFieldResolver(Lightning::Type* lightningType, Lightning::Field* lightningField, bool checkDependencies = true);
  MemberFunctionResolverIRFn FindFunctionResolver(Lightning::Type* lightningType, Lightning::Function* lightningFunction, bool checkDependencies = true);
  MemberPropertySetterResolverIRFn FindSetterResolver(Lightning::Type* lightningType, Lightning::Function* lightningFunction, bool checkDependencies = true);
  ConstructorCallResolverIRFn FindConstructorResolver(Lightning::Type* lightningType, Lightning::Function* lightningFunction, bool checkDependencies = true);
  ...
  HashMap<LightningShaderIROp*, GlobalVariableData*> mVariableOpLookupMap;
