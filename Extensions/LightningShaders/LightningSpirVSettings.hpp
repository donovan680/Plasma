...
//-------------------------------------------------------------------LightningShaderSpirVSettings
/// A collection of common settings for Lightning shader translation (current SpirV specific).
class LightningShaderSpirVSettings
{
public:
  LightningShaderSpirVSettings();
  ...
  /// Overrides the lightning name that is used to map to a spirv built-in variable for all shader stages.
