...
BoundType* InstantiateFixedArray(LibraryBuilder& builder, StringParam baseName, StringParam fullyQualifiedName, const Array<Constant>& templateTypes, const void* userData)
{
  ...
  builder.AddBoundFunction(arrayType, "Add", Plasma::DummyBoundFunction, OneParameter(templateType), core.VoidType, Lightning::FunctionOptions::None);
  builder.AddBoundFunction(arrayType, "Get", Plasma::DummyBoundFunction, OneParameter(core.IntegerType, "index"), templateType, Lightning::FunctionOptions::None);
  builder.AddBoundFunction(arrayType, "Set", Plasma::DummyBoundFunction, TwoParameters(core.IntegerType, "index", templateType, "value"), core.VoidType, Lightning::FunctionOptions::None);
  builder.AddBoundGetterSetter(arrayType, "Count", core.IntegerType, nullptr, Plasma::DummyBoundFunction, Lightning::MemberOptions::None);
...
BoundType* InstantiateGeometryInput(LibraryBuilder& builder, StringParam baseName, StringParam fullyQualifiedName, const Array<Constant>& templateTypes, const void* userData)
{
  ...
  builder.AddBoundFunction(selfType, "Get", Plasma::UnTranslatedBoundFunction, OneParameter(core.IntegerType), templateType, Lightning::FunctionOptions::None);
  builder.AddBoundFunction(selfType, "Set", Plasma::UnTranslatedBoundFunction, TwoParameters(core.IntegerType, templateType), core.VoidType, Lightning::FunctionOptions::None);
  builder.AddBoundGetterSetter(selfType, "Count", core.IntegerType, nullptr, Plasma::UnTranslatedBoundFunction, Lightning::MemberOptions::None);
...
BoundType* InstantiateGeometryOutput(LibraryBuilder& builder, StringParam baseName, StringParam fullyQualifiedName, const Array<Constant>& templateTypes, const void* userData)
{
  ...
  // Bind all of the functions and properties (stubbed out since we're only using this for translation)
  builder.AddBoundFunction(selfType, "Append", Plasma::UnTranslatedBoundFunction, TwoParameters(templateType, core.IntegerType), core.VoidType, Lightning::FunctionOptions::None);
  builder.AddBoundFunction(selfType, "Restart", Plasma::UnTranslatedBoundFunction, ParameterArray(), core.VoidType, Lightning::FunctionOptions::None);
...
BoundType* InstantiateGeometryStreamMover(LibraryBuilder& builder, StringParam baseName, StringParam fullyQualifiedName, const Array<Constant>& templateTypes, const void* userData)
{
  ...
  builder.AddBoundFunction(selfType, "Move", Plasma::UnTranslatedBoundFunction, OneParameter(fromType), toType, Lightning::FunctionOptions::Static);
