...
{
  // This function should never be called via lightning. This is a function that cannot (or hasn't yet)
...
void ResolveVectorTypeCount(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
...
void ResolvePrimitiveGet(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
...
void ResolvePrimitiveSet(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
...
void ResolveVectorGet(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  ...
  ILightningShaderIR* accessChainOp = translator->BuildCurrentBlockIROp(OpType::OpAccessChain, componentType->mPointerType, selfInstance, indexOperand, context);

  context->PushIRStack(accessChainOp);
}

void ResolveVectorSet(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  // Get the 'this' vector type and component type
  Lightning::Type* lightningVectorType = memberAccessNode->LeftOperand->ResultType;
  LightningShaderIRType* vectorType = translator->FindType(lightningVectorType, memberAccessNode->LeftOperand);
...
void ResolveMatrixGet(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  ResolveVectorGet(translator, functionCallNode, memberAccessNode, context);
}

void ResolveMatrixSet(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  ResolveVectorSet(translator, functionCallNode, memberAccessNode, context);
}

void ResolveStaticBinaryFunctionOp(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, OpType opType, LightningSpirVFrontEndContext* context)
{
  // Get the result type
...
void TranslatePrimitiveDefaultConstructor(LightningSpirVFrontEnd* translator, Lightning::Type* lightningResultType, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  ...
  ILightningShaderIR* constantZero = translator->GetConstant(componentType, constantLiteral, context);
  context->PushIRStack(constantZero);
}

void TranslatePrimitiveDefaultConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  TranslatePrimitiveDefaultConstructor(translator, fnCallNode->ResultType, context);
}

void TranslateBackupPrimitiveConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
...
void TranslateCompositeDefaultConstructor(LightningSpirVFrontEnd* translator, Lightning::Type* lightningResultType, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  LightningShaderIRType* resultType = translator->FindType(lightningResultType, nullptr);
...
void TranslateCompositeDefaultConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  TranslateCompositeDefaultConstructor(translator, fnCallNode->ResultType, context);
}

void TranslateBackupCompositeConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
...
void TranslateMatrixDefaultConstructor(LightningSpirVFrontEnd* translator, Lightning::Type* lightningResultType, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  LightningShaderIRType* resultType = translator->FindType(lightningResultType, nullptr);
...
void TranslateMatrixDefaultConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  TranslateMatrixDefaultConstructor(translator, fnCallNode->ResultType, context);
}

void TranslateMatrixFullConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  ...
  LightningShaderIROp* matrixConstructOp = translator->BuildIROpNoBlockAdd(OpType::OpCompositeConstruct, matrixType, context);
  for(size_t i = 0; i < matrixType->mComponents; ++i)
  {
    // Create each vector type but delay add it for the same reason as the matrix
    LightningShaderIROp* componentConstructOp = translator->BuildIROpNoBlockAdd(spv::OpCompositeConstruct, componentType, context);
...
LightningShaderIROp* RecursivelyTranslateCompositeSplatConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningShaderIRType* type, LightningShaderIROp* splatValueOp, LightningSpirVFrontEndContext* context)
{
  ...
  { 
    ...
    LightningShaderIROp* constituentOp = RecursivelyTranslateCompositeSplatConstructor(translator, fnCallNode, staticTypeNode, componentType, splatValueOp, context);
...
void TranslateCompositeSplatConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  LightningShaderIRType* resultType = translator->FindType(fnCallNode->ResultType, fnCallNode);
  ...
  LightningShaderIROp* constructOp= RecursivelyTranslateCompositeSplatConstructor(translator, fnCallNode, staticTypeNode, resultType, splatValueOp, context);
...
void ResolveScalarComponentAccess(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, byte componentName, LightningSpirVFrontEndContext* context)
{
...
void ResolveScalarSwizzle(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, StringParam memberName, LightningSpirVFrontEndContext* context)
{
...
void ScalarBackupFieldResolver(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
...
void ResolveVectorComponentAccess(LightningSpirVFrontEnd* translator, LightningShaderIROp* selfInstance, LightningShaderIRType* componentType, byte componentName, LightningSpirVFrontEndContext* context)
{
  ...
  if(selfInstance->IsResultPointerType())
  {
    ...
    LightningShaderIROp* accessChainOp = translator->BuildCurrentBlockIROp(OpType::OpAccessChain, componentType->mPointerType, selfInstance, indexOp, context);
    context->PushIRStack(accessChainOp);
  }
  ...
  else
  {
    ...
    LightningShaderIROp* accessChainOp = translator->BuildCurrentBlockIROp(OpType::OpCompositeExtract, componentType, selfInstance, indexLiteral, context);
    context->PushIRStack(accessChainOp);
  }
}

void ResolveVectorComponentAccess(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, byte componentName, LightningSpirVFrontEndContext* context)
{
  ...
  LightningShaderIRType* operandType = translator->FindType(memberAccessNode->LeftOperand->ResultType, memberAccessNode->LeftOperand);
...
void ResolveVectorSwizzle(LightningSpirVFrontEnd* translator, ILightningShaderIR* selfInstance, LightningShaderIRType* resultType, StringParam memberName, LightningSpirVFrontEndContext* context)
{
  // The swizzle instruction (vector shuffle) requires value types
  ...
  LightningShaderIROp* swizzleOp = translator->BuildCurrentBlockIROp(OpType::OpVectorShuffle, resultType, operandValueOp, operandValueOp, context);
...
void ResolveVectorSwizzle(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, StringParam memberName, LightningSpirVFrontEndContext* context)
{
  // Figure out what the result type of this swizzle is
  LightningShaderIRType* resultType = translator->FindType(memberAccessNode->ResultType, memberAccessNode);
...
void VectorBackupFieldResolver(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
...
void ResolverVectorSwizzleSetter(LightningSpirVFrontEnd* translator, ILightningShaderIR* selfInstance, LightningShaderIROp* resultValue, LightningShaderIRType* resultType, StringParam memberName, LightningSpirVFrontEndContext* context)
{
  ...
  LightningShaderIROp* shuffleOp = translator->BuildCurrentBlockIROp(OpType::OpVectorShuffle, resultType, instanceValue, resultValue, context);
...
void ResolverVectorSwizzleSetter(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningShaderIROp* resultValue, LightningSpirVFrontEndContext* context)
{
  String memberName = memberAccessNode->Name;
  LightningShaderIRType* resultType = translator->FindType(memberAccessNode->LeftOperand->ResultType, memberAccessNode->LeftOperand);
...
void VectorBackupPropertySetter(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningShaderIROp* resultValue, LightningSpirVFrontEndContext* context)
{
  String memberName = memberAccessNode->Name;
...
bool MatrixElementAccessResolver(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context, Lightning::MatrixUserData& matrixUserData)
{
  ...
  LightningShaderIROp* accessOp = translator->BuildCurrentBlockIROp(OpType::OpAccessChain, resultType->mPointerType, operandResult, indexYConstant, indexXConstant, context);
  context->PushIRStack(accessOp);
  return true;
}

void MatrixBackupFieldResolver(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
...
void TranslateQuaternionDefaultConstructor(LightningSpirVFrontEnd* translator, Lightning::Type* lightningResultType, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  ...
  ILightningShaderIR* constantZero = translator->GetConstant(realType, 0.0f, context);
  ...
  LightningShaderIROp* constructOp = translator->BuildIROp(context->GetCurrentBlock(), OpType::OpCompositeConstruct, quaternionType, vec4ConstructOp, context);
  context->PushIRStack(constructOp);
}

void TranslateQuaternionDefaultConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  TranslateQuaternionDefaultConstructor(translator, fnCallNode->ResultType, context);
}

void QuaternionBackupFieldResolver(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  ...
  LightningShaderIROp* vec4Instance = translator->BuildCurrentBlockIROp(OpType::OpAccessChain, vec4Type->mPointerType, selfInstance, vec4OffsetConstant, context);
...
void QuaternionBackupPropertySetter(LightningSpirVFrontEnd* translator, Lightning::MemberAccessNode* memberAccessNode, LightningShaderIROp* resultValue, LightningSpirVFrontEndContext* context)
{
  String memberName = memberAccessNode->Name;
...
void ResolveQuaternionTypeCount(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
...
void ResolveQuaternionGet(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  ILightningShaderIR* leftOperand = translator->WalkAndGetResult(memberAccessNode->LeftOperand, context);
  LightningShaderIROp* selfInstance = translator->GetOrGeneratePointerTypeFromIR(leftOperand, context);
  LightningShaderIRType* vec4Type = selfInstance->mResultType->mDereferenceType->GetSubType(0);
  ...
  // Generate the access chain to get the element within the vector
  ILightningShaderIR* accessChainOp = translator->BuildCurrentBlockIROp(OpType::OpAccessChain, realType->mPointerType, vec4Instance, indexOperand, context);

  context->PushIRStack(accessChainOp);
}

void ResolveQuaternionSet(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  ILightningShaderIR* leftOperand = translator->WalkAndGetResult(memberAccessNode->LeftOperand, context);
  LightningShaderIROp* selfInstance = translator->GetOrGeneratePointerTypeFromIR(leftOperand, context);
  LightningShaderIRType* vec4Type = selfInstance->mResultType->mDereferenceType->GetSubType(0);
  ...
  LightningShaderIROp* vec4Instance = translator->BuildCurrentBlockIROp(OpType::OpAccessChain, vec4Type->mPointerType, selfInstance, offsetConstant, context);
...
void TranslateQuaternionSplatConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  ...
  LightningShaderIROp* subConstructOp = RecursivelyTranslateCompositeSplatConstructor(translator, fnCallNode, staticTypeNode, vec4Type, splatValueOp, context);

  // Construct the quaternion from the vec4
  LightningShaderIROp* vec4Value = translator->GetOrGenerateValueTypeFromIR(subConstructOp, context);
  LightningShaderIROp* quaternionConstructOp = translator->BuildCurrentBlockIROp(OpType::OpCompositeConstruct, quaternionType, vec4Value, context);

  context->PushIRStack(quaternionConstructOp);
}

void TranslateBackupQuaternionConstructor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* fnCallNode, Lightning::StaticTypeNode* staticTypeNode, LightningSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();
  LightningShaderIRType* quaternionType = translator->FindType(fnCallNode->ResultType, fnCallNode);
  LightningShaderIRType* vec4Type = quaternionType->GetSubType(0);
  ...
  LightningShaderIROp* quaternionConstructOp = translator->BuildCurrentBlockIROp(OpType::OpCompositeConstruct, quaternionType, vec4ConstructOp, context);
  // Also mark this as the return of this tree
  context->PushIRStack(quaternionConstructOp);
}

void ResolveColor(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* /*functionCallNode*/, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
...
void RegisterColorsOps(LightningSpirVFrontEnd* translator, LightningShaderIRLibrary* shaderLibrary, TypeGroups& types)
{
  ...
  LightningShaderIRType* colorsShaderType = translator->MakeStructType(shaderLibrary, colors->Name, colors, spv::StorageClass::StorageClassGeneric);
  TypeResolvers& typeResolver = shaderLibrary->mTypeResolvers[colors];

  // the only way to get the value for each color during translation is to compile and execute lightning.
