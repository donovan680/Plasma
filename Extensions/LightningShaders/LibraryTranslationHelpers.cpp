...
Lightning::Function* GetFunction(Lightning::Type* type, StringParam fnName, Array<String>& params, const Lightning::FunctionArray* functions)
{
...
Lightning::Function* GetMemberOverloadedFunction(Lightning::Type* type, StringParam fnName, StringParam p0, StringParam p1, StringParam p2)
{
  Array<String> params;
  params.PushBack(p0);
  params.PushBack(p1);
...
Lightning::Function* GetMemberOverloadedFunction(Lightning::Type* type, StringParam fnName, StringParam p0, StringParam p1, StringParam p2, StringParam p3)
{
  Array<String> params;
  params.PushBack(p0);
  params.PushBack(p1);
...
Lightning::Function* GetStaticFunction(Lightning::Type* type, StringParam fnName, StringParam p0, StringParam p1, StringParam p2)
{
  Array<String> params;
  params.PushBack(p0);
  params.PushBack(p1);
...
Lightning::Function* GetStaticFunction(Lightning::Type* type, StringParam fnName, StringParam p0, StringParam p1, StringParam p2, StringParam p3)
{
  Array<String> params;
  params.PushBack(p0);
  params.PushBack(p1);
...
Lightning::Function* GetStaticFunction(Lightning::Type* type, StringParam fnName, StringParam p0, StringParam p1, StringParam p2, StringParam p3, StringParam p4)
{
  Array<String> params;
  params.PushBack(p0);
  params.PushBack(p1);
