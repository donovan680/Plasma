...
struct ShaderResourceReflectionData
{
  ...
  /// generated this reflection data (e.g. in Lightning this is Real3 but in glsl this is vec3).
  String mTypeName;
...
{
  /// The name of the type that created this shader. Used to find the actual lightning type if necessary.
