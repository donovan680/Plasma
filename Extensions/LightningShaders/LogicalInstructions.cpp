...
void ResolveLogicalBinaryOp(LightningSpirVFrontEnd* translator, Lightning::BinaryOperatorNode* binaryOpNode, LightningSpirVFrontEndContext* context)
{
...
template <OpType opType>
void ResolveLogicalUnaryOp(LightningSpirVFrontEnd* translator, Lightning::UnaryOperatorNode* unaryOpNode, LightningSpirVFrontEndContext* context)
{
...
void ResolveAnyAllNonZero(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, OpType op, LightningSpirVFrontEndContext* context)
{
...
void ResolveAllNonZero(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  ResolveAnyAllNonZero(translator, functionCallNode, OpType::OpAll, context);
}

void ResolveAnyNonZero(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
...
void ResolveLogicalOrAnd(LightningSpirVFrontEnd* translator, Lightning::BinaryOperatorNode* binaryOpNode, bool isOr, LightningSpirVFrontEndContext* context)
{
...
void ResolveLogicalOr(LightningSpirVFrontEnd* translator, Lightning::BinaryOperatorNode* binaryOpNode, LightningSpirVFrontEndContext* context)
{
  ResolveLogicalOrAnd(translator, binaryOpNode, true, context);
}

void ResolveLogicalAnd(LightningSpirVFrontEnd* translator, Lightning::BinaryOperatorNode* binaryOpNode, LightningSpirVFrontEndContext* context)
{
...
void RegisterLogicalOps(LightningSpirVFrontEnd* translator, LightningShaderIRLibrary* shaderLibrary, TypeGroups& types)
{
  ...
  for(size_t i = 0; i < types.mRealVectorTypes.Size(); ++i)
  {
    ...
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::Equality, ResolveLogicalBinaryOp<OpType::OpFOrdEqual>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::Inequality, ResolveLogicalBinaryOp<OpType::OpFOrdNotEqual>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::GreaterThan, ResolveLogicalBinaryOp<OpType::OpFOrdGreaterThan>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::GreaterThanOrEqualTo, ResolveLogicalBinaryOp<OpType::OpFOrdGreaterThanEqual>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::LessThan, ResolveLogicalBinaryOp<OpType::OpFOrdLessThan>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::LessThanOrEqualTo, ResolveLogicalBinaryOp<OpType::OpFOrdLessThanEqual>);
  }
  ...
  for(size_t i = 0; i < types.mIntegerVectorTypes.Size(); ++i)
  {
    ...
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::Equality, ResolveLogicalBinaryOp<OpType::OpIEqual>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::Inequality, ResolveLogicalBinaryOp<OpType::OpINotEqual>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::GreaterThan, ResolveLogicalBinaryOp<OpType::OpSGreaterThan>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::GreaterThanOrEqualTo, ResolveLogicalBinaryOp<OpType::OpSGreaterThanEqual>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::LessThan, ResolveLogicalBinaryOp<OpType::OpSLessThan>);
    opResolvers.RegisterBinaryOpResolver(lightningType, lightningType, Lightning::Grammar::LessThanOrEqualTo, ResolveLogicalBinaryOp<OpType::OpSLessThanEqual>);
  }

  // Register bool scalar ops
  opResolvers.RegisterBinaryOpResolver(boolType, boolType, Lightning::Grammar::Equality, ResolveLogicalBinaryOp<OpType::OpLogicalEqual>);
  opResolvers.RegisterBinaryOpResolver(boolType, boolType, Lightning::Grammar::Inequality, ResolveLogicalBinaryOp<OpType::OpLogicalNotEqual>);
  ...
  {
    Lightning::BoundType* lightningType = types.mBooleanVectorTypes[i]->mLightningType;
    String lightningTypeName = lightningType->ToString();

    opResolvers.RegisterUnaryOpResolver(lightningType, Lightning::Grammar::LogicalNot, ResolveLogicalUnaryOp<OpType::OpLogicalNot>);

    mathTypeResolver.RegisterFunctionResolver(GetStaticFunction(mathType, "AllNonZero", lightningTypeName), ResolveAllNonZero);
    mathTypeResolver.RegisterFunctionResolver(GetStaticFunction(mathType, "AnyNonZero", lightningTypeName), ResolveAnyNonZero);
  }
}
