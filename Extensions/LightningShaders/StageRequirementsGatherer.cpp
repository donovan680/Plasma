...
bool StageRequirementsGatherer::Run(Lightning::SyntaxTree& syntaxTree, LightningShaderIRLibrary* library, ShaderCompilationErrors* errors)
{
  mErrors = errors;
  ...
  // Walk all dependency libraries to build a mapping of lightning libraries to shader libraries.
  // This could potentially be done faster but this will never be a bottleneck.
  BuildLibraryMap(library, &context);

  // Do a pre-walk in order to build a map of nodes to lightning objects. This is needed during
...
void StageRequirementsGatherer::PreWalkConstructor(Lightning::ConstructorNode*& node, StageRequirementsGathererContext* context)
{
  context->mConstructorMap[node->DefinedFunction] = node;
}

void StageRequirementsGatherer::PreWalkClassFunction(Lightning::FunctionNode*& node, StageRequirementsGathererContext* context)
{
  context->mFunctionMap[node->DefinedFunction] = node;
}

void StageRequirementsGatherer::PreWalkClassMemberVariable(Lightning::MemberVariableNode*& node, StageRequirementsGathererContext* context)
{
...
void StageRequirementsGatherer::WalkClassPreconstructor(Lightning::ClassNode*& node, StageRequirementsGathererContext* context)
{
...
void StageRequirementsGatherer::WalkClassPreconstructor(Lightning::Function* preConstructor, StageRequirementsGathererContext* context)
{
...
void StageRequirementsGatherer::WalkClassConstructor(Lightning::ConstructorNode*& node, StageRequirementsGathererContext* context)
{
...
void StageRequirementsGatherer::WalkClassMemberVariable(Lightning::MemberVariableNode*& node, StageRequirementsGathererContext* context)
{
...
void StageRequirementsGatherer::WalkMemberAccessNode(Lightning::MemberAccessNode*& node, StageRequirementsGathererContext* context)
{
  ...
  if(lightningFunction != nullptr)
  {
    ...
    // a different lightning function then the one we started with. This is the one that should
...
void StageRequirementsGatherer::WalkStaticTypeNode(Lightning::StaticTypeNode*& node, StageRequirementsGathererContext* context)
{
...
void StageRequirementsGatherer::MergeCurrent(LightningShaderIRLibrary* shaderLibrary, Lightning::Member* lightningMember, Lightning::SyntaxNode* node, StageRequirementsGathererContext* context)
{
...
void StageRequirementsGatherer::BuildLibraryMap(LightningShaderIRLibrary* library, StageRequirementsGathererContext* context)
{
...
ShaderStage::Enum StageRequirementsGatherer::GetRequiredStages(Lightning::Member* lightningObject, Lightning::ReflectionObject* owner)
{
...
void StageRequirementsGatherer::CheckAndDispatchErrors(Lightning::Member* lightningObject, Lightning::ReflectionObject* owner, StageRequirementsGathererContext* context)
{
  ...
  while(currentObj != nullptr)
  {
    ...
    LightningShaderIRLibrary* objectLibrary = context->mLightningLibraryToShaderLibraryMap.FindValue(lightningSourceLibrary, nullptr);
