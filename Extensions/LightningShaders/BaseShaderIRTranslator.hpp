...
public:
  ...
  /// be put together with a backend (e.g. LightningSpirVDisassemblerBackend)
  virtual bool Translate(Lightning::SyntaxTree& syntaxTree, LightningShaderIRProject* project, LightningShaderIRLibrary* library) = 0;
