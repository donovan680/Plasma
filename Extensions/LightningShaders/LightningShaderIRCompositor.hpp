...
public:
  ...
  bool Composite(ShaderDefinition& shaderDef, const ShaderCapabilities& capabilities, LightningShaderSpirVSettingsRef& settings);
  ...
  void Link(StageAttachmentLinkingInfo& prevStageInfo, StageLinkingInfo* currentStage, Array<LightningShaderIRType*>& fragmentTypes, StageAttachmentLinkingInfo& currStageInfo);
  ...
  void GenerateLightningComposite(StageLinkingInfo* currentStage, ShaderStageDescription& stageResults, ShaderIRAttributeList& extraAttributes);
  void GenerateBasicLightningComposite(StageLinkingInfo* currentStage, ShaderStageDescription& stageResults, ShaderIRAttributeList& extraAttributes);
  void GenerateGeometryLightningComposite(StageLinkingInfo* currentStage, ShaderStageDescription& stageResults, ShaderIRAttributeList& extraAttributes);
  void GenerateComputeLightningComposite(StageLinkingInfo* currentStage, ShaderStageDescription& stageResults, ShaderIRAttributeList& extraAttributes);
  void CreateFragmentAndCopyInputs(StageLinkingInfo* currentStage, ShaderCodeBuilder& builder, StringParam currentClassName, LightningShaderIRType* fragmentType, StringParam fragmentVarName);
