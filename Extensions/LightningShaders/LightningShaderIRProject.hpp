...
public:
  ...
  bool CompileTree(Lightning::Module& lightningDependencies, Lightning::LibraryRef& lightningLibrary, Lightning::SyntaxTree& syntaxTree, Lightning::Array<Lightning::UserToken>& tokensOut);
