...
struct ShaderInterfaceType
{
  ...
  virtual LightningShaderIROp* GetFieldPointerByIndex(size_t index, EntryPointGeneration* entryPointGeneration, BasicBlock* block, spv::StorageClass storageClass) = 0;
...
struct ShaderInterfaceStruct : public ShaderInterfaceType
{
  ...
  LightningShaderIROp* GetFieldPointerByIndex(size_t index, EntryPointGeneration* entryPointGeneration, BasicBlock* block, spv::StorageClass storageClass) override;

  // Get the field by index off of the given instance. Used internally and when this is a sub-type in an array.
  LightningShaderIROp* GetFieldPointerByIndex(LightningShaderIROp* instance, size_t index, EntryPointGeneration* entryPointGeneration, BasicBlock* block, spv::StorageClass storageClass);
...
struct ShaderInterfaceStructArray : public ShaderInterfaceStruct
{
  ...
  LightningShaderIROp* GetPointerByIndex(ILightningShaderIR* index, ShaderFieldKey& fieldKey, EntryPointGeneration* entryPointGeneration, BasicBlock* block, spv::StorageClass storageClass);
...
public:
  ...
  void DeclareVertexInterface(LightningSpirVFrontEnd* translator, Lightning::GenericFunctionNode* node, LightningShaderIRFunction* function, LightningSpirVFrontEndContext* context);
  void DeclareGeometryInterface(LightningSpirVFrontEnd* translator, Lightning::GenericFunctionNode* node, LightningShaderIRFunction* function, LightningSpirVFrontEndContext* context);
  void DeclarePixelInterface(LightningSpirVFrontEnd* translator, Lightning::GenericFunctionNode* node, LightningShaderIRFunction* function, LightningSpirVFrontEndContext* context);
  void DeclareComputeInterface(LightningSpirVFrontEnd* translator, Lightning::GenericFunctionNode* node, LightningShaderIRFunction* function, LightningSpirVFrontEndContext* context);
  ...
  void CreateEntryPointFunction(Lightning::GenericFunctionNode* node, LightningShaderIRFunction* function, LightningShaderIROp*& selfVarOp, BasicBlock*& entryPointBlock);
  void BuildBasicEntryPoint(Lightning::GenericFunctionNode* node, LightningShaderIRFunction* function, LightningShaderIRFunction* copyInputsFn, LightningShaderIRFunction* copyOutputsFn);
  ...
  EntryPointHelperFunctionData GenerateGeometryCopyHelper(LightningShaderIRFunction* userMainFn, StringParam name, LightningShaderIRType* inputStreamType, LightningShaderIROp*& inputStreamVar);
  void WriteGeometryStageInterface(LightningShaderIRFunction* function, GeometryStageInfo& stageInfo, EntryPointInfo* entryPointInfo, EntryPointHelperFunctionData& copyInputsData, LightningShaderIROp* copyInputsStreamVar);
  ...
  void GenerateProvokingVertexAppend(GeometryStageInfo& stageInfo, EntryPointInfo* entryPointInfo, GeometryAppendFunctionData& appendFnData, LightningShaderIRType* outputStreamType);
  ...
  void CollectInterfaceVariables(LightningShaderIRFunction* function, ShaderInterfaceInfo& interfaceInfo, ShaderStage::Enum shaderStage);
  void CollectInputInterfaceVariables(LightningShaderIRFunction* function, ShaderInterfaceInfo& interfaceInfo, LightningShaderIRType* type, ShaderStage::Enum shaderStage);
  void CollectOutputInterfaceVariables(LightningShaderIRFunction* function, ShaderInterfaceInfo& interfaceInfo, LightningShaderIRType* type, ShaderStage::Enum shaderStage);
  void CollectUniformInterfaceVariables(LightningShaderIRFunction* function, ShaderInterfaceInfo& interfaceInfo, LightningShaderIRType* type, ShaderStage::Enum shaderStage);

  void ProcessUniformBlockSettings(ShaderStage::Enum stageToProcess, HashMap<ShaderFieldKey, UniformBufferDescription*>& mapping);
  InterfaceInfoGroup* ProcessBuiltIn(LightningShaderIRFunction* function, ShaderInterfaceInfo& interfaceInfo, ShaderStage::Enum shaderStage, ShaderIRFieldMeta* fieldMeta, ShaderIRAttribute* attribute, spv::StorageClass storageClass, StringParam name);
  InterfaceInfoGroup* ProcessUniformBlock(LightningShaderIRFunction* function, ShaderInterfaceInfo& interfaceInfo, ShaderIRFieldMeta* fieldMeta, ShaderIRAttribute* attribute, HashMap<ShaderFieldKey, UniformBufferDescription*>& mapping);
  ...
  void CopyField(BasicBlock* targetFnBlock, LightningShaderIRType* sourceLoadType, LightningShaderIROp* source, LightningShaderIROp* dest);
  void CopyFromInterfaceType(BasicBlock* block, LightningShaderIROp* dest, LightningShaderIROp* source, ShaderInterfaceType* sourceInterface, spv::StorageClass destStorageClass, spv::StorageClass sourceStorageClass);
  LightningShaderIROp* GetMemberInstanceFrom(BasicBlock* block, LightningShaderIROp* source, int sourceOffset, spv::StorageClass sourceStorageClass);
  LightningShaderIROp* GetNamedMemberInstanceFrom(BasicBlock* block, LightningShaderIROp* source, StringParam memberName, spv::StorageClass sourceStorageClass);
  LightningShaderIROp* GetNamedMemberInstanceFrom(BasicBlock* block, LightningShaderIROp* source, const ShaderFieldKey& fieldKey, spv::StorageClass sourceStorageClass);
  ...
  void AddMemberTypeDecorations(LightningShaderIRType* memberType, InterfaceInfoGroup::FieldInfo& fieldInfo, ShaderResourceReflectionData& memberReflection);
  void AddVertexLocationDecorations(InterfaceInfoGroup& infoGroup);
  void AddFlatDecorations(InterfaceInfoGroup& infoGroup);
  void WriteTypeDecorations(Array<InterfaceInfoGroup::DecorationParam>& decorations, BasicBlock* decorationBlock, ILightningShaderIR* toDecorate);
  void WriteMemberDecorations(Array<InterfaceInfoGroup::DecorationParam>& decorations, BasicBlock* decorationBlock, ILightningShaderIR* toDecorate, LightningShaderIRConstantLiteral* memberIndexLiteral);
  ...
  void AddRuntimeArrayDecorations(BasicBlock* decorationBlock, LightningShaderIRType* lightningRuntimeArrayType, LightningShaderIRType* spirvRuntimeArrayType, LightningShaderIRType* elementType, ShaderStageResource& stageResource);
  /// Recursively decorate a struct (currently setup for runtime arrays)
  void RecursivelyDecorateStructType(BasicBlock* decorationBlock, LightningShaderIRType* structType, ShaderStageResource& stageResource);
  ...
  LightningShaderIROp* FindField(ShaderFieldKey& fieldKey, Array<ShaderInterfaceType*>& interfaces, BasicBlock* block, spv::StorageClass storageClass);
