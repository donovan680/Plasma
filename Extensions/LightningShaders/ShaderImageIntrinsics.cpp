...
void WriteImageArguments(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, LightningShaderIROp* result, int index, ImageUserData& imageData, LightningSpirVFrontEndContext* context)
{
...
inline void ResolveCombinedSamplerFunction(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
...
template <OpType opType>
inline void ResolveSplitImageSamplerFunction(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  ImageUserData& imageData = memberAccessNode->AccessedFunction->ComplexUserData.ReadObject<ImageUserData>(0);
  LightningShaderIRType* resultType = translator->FindType(functionCallNode->ResultType, functionCallNode);
  ...
  LightningShaderIROp* sampledImageValue = translator->BuildCurrentBlockIROp(OpType::OpSampledImage, sampledImageType, imageValue, samplerValue, context);
...
template <OpType opType>
inline void ResolveImageFunction(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningSpirVFrontEndContext* context)
{
  ImageUserData& imageData = memberAccessNode->AccessedFunction->ComplexUserData.ReadObject<ImageUserData>(0);
  LightningShaderIRType* resultType = translator->FindType(functionCallNode->ResultType, functionCallNode);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* returnType)
{
  ...
  fn = builder.AddBoundFunction(type, "SampleImplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* lodType, Lightning::BoundType* returnType)
{
  ...
  fn = builder.AddBoundFunction(type, "SampleExplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* derivativeType, Lightning::BoundType* returnType)
{
  ...
  fn = builder.AddBoundFunction(type, "SampleGradExplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  fn->UserData = (void*)&ResolveCombinedSamplerFunction<OpType::OpImageSampleExplicitLod>;
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* depthType, Lightning::BoundType* returnType)
{
  ...
  fn = builder.AddBoundFunction(type, "SampleDRefImplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* depthType, Lightning::BoundType* lodType, Lightning::BoundType* returnType)
{
  ...
  fn = builder.AddBoundFunction(type, "SampleDRefExplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* returnType)
{
  ...
  parameters = TwoParameters(set.mSampledImageType, "sampledImage", coordinateType, "coordinate");
  fn = builder.AddBoundFunction(type, "SampleProjImplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* lodType, Lightning::BoundType* returnType)
{
  ...
  parameters = ThreeParameters(set.mSampledImageType, "sampledImage", coordinateType, "coordinate", lodType, "lod");
  fn = builder.AddBoundFunction(type, "SampleProjExplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* depthType, Lightning::BoundType* returnType)
{
  ...
  parameters = ThreeParameters(set.mSampledImageType, "sampledImage", coordinateType, "coordinate", depthType, "depth");
  fn = builder.AddBoundFunction(type, "SampleProjDRefImplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* depthType, Lightning::BoundType* lodType, Lightning::BoundType* returnType)
{
  ...
  parameters = FourParameters(set.mSampledImageType, "sampledImage", coordinateType, "coordinate", depthType, "depth", lodType, "lod");
  fn = builder.AddBoundFunction(type, "SampleProjDRefExplicitLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
...
void AddImageFetch(Lightning::LibraryBuilder& builder, Lightning::BoundType* type, SampledImageSet& set,
  Lightning::BoundType* coordianteType, Lightning::BoundType* returnType)
{
  Lightning::Function* fn = nullptr;
  ParameterArray parameters;

  parameters = TwoParameters(set.mImageType, "image", coordianteType, "coordinate");
  fn = builder.AddBoundFunction(type, "ImageFetch", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
...
void AddImageFetchLod(Lightning::LibraryBuilder& builder, Lightning::BoundType* type, SampledImageSet& set,
  ...
  Lightning::BoundType* lodType, Lightning::BoundType* returnType)
{
  ...
  fn = builder.AddBoundFunction(type, "ImageQuerySize", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
  ...
  Lightning::BoundType* coordinateType, Lightning::BoundType* returnType)
{
  ...
  parameters = TwoParameters(set.mSampledImageType, "sampledImage", coordinateType, "coordinate");
  fn = builder.AddBoundFunction(type, "ImageQueryLod", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
...
void AddImageQueryLevels(Lightning::LibraryBuilder& builder, Lightning::BoundType* type, SampledImageSet& set, Lightning::BoundType* returnType)
{
  ...
  fn = builder.AddBoundFunction(type, "ImageQueryLevels", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
...
void AddImageRead(Lightning::LibraryBuilder& builder, Lightning::BoundType* type, SampledImageSet& set, Lightning::BoundType* coordinateType, Lightning::BoundType* returnType)
{
  Lightning::BoundType* imageType = set.mImageType;
  if(imageType == nullptr)
    return;
  ...
  fn = builder.AddBoundFunction(type, "ImageRead", UnTranslatedBoundFunction, parameters, returnType, Lightning::FunctionOptions::Static);
...
void AddImageWrite(Lightning::LibraryBuilder& builder, Lightning::BoundType* type, SampledImageSet& set, Lightning::BoundType* coordinateType, Lightning::BoundType* texelType)
{
  Lightning::BoundType* imageType = set.mImageType;
  if(imageType == nullptr)
    return;
  ...
  fn = builder.AddBoundFunction(type, "ImageWrite", UnTranslatedBoundFunction, parameters, LightningTypeId(void), Lightning::FunctionOptions::Static);
...
void AddImageFunctions(Lightning::LibraryBuilder& builder, Lightning::BoundType* type, TypeGroups& types)
{
  ...
  Lightning::BoundType* int2Type = types.mIntegerVectorTypes[1]->mLightningType;
  Lightning::BoundType* realType = types.mRealVectorTypes[0]->mLightningType;
  Lightning::BoundType* real2Type = types.mRealVectorTypes[1]->mLightningType;
  Lightning::BoundType* real3Type = types.mRealVectorTypes[2]->mLightningType;
  Lightning::BoundType* real4Type = types.mRealVectorTypes[3]->mLightningType;
