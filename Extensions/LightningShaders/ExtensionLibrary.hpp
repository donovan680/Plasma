...
typedef void(*SpirVExtensionInstructionResolverFn)(LightningSpirVFrontEnd* translator, Lightning::FunctionCallNode* functionCallNode, Lightning::MemberAccessNode* memberAccessNode, LightningShaderExtensionImport* importLibraryIR, LightningSpirVFrontEndContext* context);
