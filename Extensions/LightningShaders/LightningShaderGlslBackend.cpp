...
bool LightningShaderGlslBackend::RunTranslationPass(ShaderTranslationPassResult& inputData, ShaderTranslationPassResult& outputData)
{
  mErrorLog.Clear();
...
void LightningShaderGlslBackend::PopulateTypeName(GlslBackendInternalData& internalData, spirv_cross::SPIRType& spirVType, ShaderResourceReflectionData& reflectionData)
{
  spirv_cross::CompilerGLSL* compiler = internalData.mCompiler;
...
void LightningShaderGlslBackend::PopulateMemberTypeInfo(GlslBackendInternalData& internalData, spirv_cross::SPIRType& parentType, int memberIndex, ShaderResourceReflectionData& reflectionData, bool isInterfaceType)
{
  spirv_cross::CompilerGLSL* compiler = internalData.mCompiler;
...
void LightningShaderGlslBackend::PopulateTypeInfo(GlslBackendInternalData& internalData, spirv_cross::SPIRType& spirvType, ShaderResourceReflectionData& reflectionData, bool isInterfaceType)
{
  spirv_cross::CompilerGLSL* compiler = internalData.mCompiler;
...
void LightningShaderGlslBackend::ExtractResourceReflection(GlslBackendInternalData& internalData, spirv_cross::Resource& resource, Array<ShaderStageResource>& results, bool isInterfaceType)
{
  spirv_cross::CompilerGLSL* compiler = internalData.mCompiler;
  spirv_cross::ShaderResources* resources = internalData.mResources;
...
void LightningShaderGlslBackend::ExtractResourcesReflection(GlslBackendInternalData& internalData, std::vector<spirv_cross::Resource>& resources, Array<ShaderStageResource>& results, bool isInterfaceType)
{
