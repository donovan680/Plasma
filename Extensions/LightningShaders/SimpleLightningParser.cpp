...
void SimpleLightningParser::WalkStaticTypeOrCreationCallNode(Lightning::StaticTypeNode*& node, SimpleLightningParserContext* context)
{
  context->mBuilder << node->ReferencedType->Name;
}
void SimpleLightningParser::WalkExpressionInitializerNode(Lightning::ExpressionInitializerNode*& node, SimpleLightningParserContext* context)
{
...
void SimpleLightningParser::WalkGetterSetter(Lightning::MemberAccessNode*& node, Lightning::GetterSetter* getSet, SimpleLightningParserContext* context)
{
