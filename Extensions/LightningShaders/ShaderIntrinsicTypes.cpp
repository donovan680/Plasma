...
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName, ParameterArray& params)
{
  Lightning::Function* lightningFn = builder.AddBoundFunction(owner, fnName, UnTranslatedBoundFunction, params, returnType, Lightning::FunctionOptions::Static);
  lightningFn->UserData = (void*)&ResolveSimpleFunction<opType>;
  return lightningFn;
}

template <OpType opType>
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName)
{
...
template <OpType opType>
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName,
  Lightning::BoundType* param0Type, StringParam param0Name)
{
...
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName,
  Lightning::BoundType* param0Type, StringParam param0Name,
  Lightning::BoundType* param1Type, StringParam param1Name)
{
  DelegateParameter param0(param0Type);
  param0.Name = param0Name;
...
template <OpType opType>
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName,
  Lightning::BoundType* param0Type, Lightning::BoundType* param1Type)
{
...
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName,
  Lightning::BoundType* param0Type, StringParam param0Name,
  Lightning::BoundType* param1Type, StringParam param1Name,
  Lightning::BoundType* param2Type, StringParam param2Name)
{
  DelegateParameter param0(param0Type);
  param0.Name = param0Name;
  DelegateParameter param1(param1Type);
...
template <OpType opType>
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName,
  Lightning::BoundType* param0Type, Lightning::BoundType* param1Type, Lightning::BoundType* param2Type)
{
...
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName,
  ...
  Lightning::BoundType* param1Type, StringParam param1Name,
  Lightning::BoundType* param2Type, StringParam param2Name,
  Lightning::BoundType* param3Type, StringParam param3Name)
{
  DelegateParameter param0(param0Type);
  param0.Name = param0Name;
  DelegateParameter param1(param1Type);
...
template <OpType opType>
Lightning::Function* AddFunction(Lightning::LibraryBuilder& builder, Lightning::BoundType* owner, Lightning::BoundType* returnType, StringParam fnName,
  Lightning::BoundType* param0Type, Lightning::BoundType* param1Type, Lightning::BoundType* param2Type, Lightning::BoundType* param3Type)
{
...
void AddMathOps(Lightning::LibraryBuilder& builder, Lightning::BoundType* type, TypeGroups& types)
{
  Lightning::BoundType* voidType = LightningTypeId(void);
  Lightning::BoundType* boolType = types.mBooleanVectorTypes[0]->mLightningType;
  ...
  for(size_t i = 0; i < types.mBooleanVectorTypes.Size(); ++i)
  {
    ...
    AddFunction<OpType::OpSelect>(builder, type, lightningType, "Select", vectorBoolType, "condition", lightningType, "obj1", lightningType, "obj2");
  }
  ...
  for(size_t i = 0; i < types.mIntegerVectorTypes.Size(); ++i)
  {
    ...
    Lightning::BoundType* vectorBoolType = types.mBooleanVectorTypes[i]->mLightningType;
    ...
    // Binary
    AddFunction<OpType::OpShiftRightLogical>(builder, type, lightningType, "ShiftRightLogical", lightningType, "base", lightningType, "shift");
    AddFunction<OpType::OpShiftRightArithmetic>(builder, type, lightningType, "ShiftRightArithmetic", lightningType, "base", lightningType, "shift");
    AddFunction<OpType::OpShiftLeftLogical>(builder, type, lightningType, "ShiftLeftLogical", lightningType, "base", lightningType, "shift");
    ...
    // Tri
    AddFunction<OpType::OpSelect>(builder, type, lightningType, "Select", vectorBoolType, "condition", lightningType, "obj1", lightningType, "obj2");
    AddFunction<OpType::OpBitFieldSExtract>(builder, type, lightningType, "BitFieldExtract", lightningType, "base", intType, "offset", intType, "count");

    // Quad
    AddFunction<OpType::OpBitFieldInsert>(builder, type, lightningType, "BitFieldInsert", lightningType, "base", lightningType, "insert", intType, "offset", intType, "count");
  }
  ...
  for(size_t i = 0; i < types.mRealVectorTypes.Size(); ++i)
  {
    ...
    // Unary
    AddFunction<OpType::OpDPdx>(builder, type, lightningType, "Ddx", lightningType)->AddAttribute(SpirVNameSettings::mRequiresPixelAttribute);
    AddFunction<OpType::OpDPdy>(builder, type, lightningType, "Ddy", lightningType)->AddAttribute(SpirVNameSettings::mRequiresPixelAttribute);
    AddFunction<OpType::OpFwidth>(builder, type, lightningType, "FWidth", lightningType)->AddAttribute(SpirVNameSettings::mRequiresPixelAttribute);
    ...
    AddFunction<OpType::OpFOrdLessThanEqual>(builder, type, vectorBoolType, "OrderedLessThanEqual", lightningType, lightningType);
    AddFunction<OpType::OpFOrdGreaterThan>(builder, type, vectorBoolType, "OrderedGreaterThan", lightningType, lightningType);
    AddFunction<OpType::OpFOrdGreaterThanEqual>(builder, type, vectorBoolType, "OrderedGreaterThanEqual", lightningType, lightningType);
    ...
    AddFunction<OpType::OpFUnordLessThanEqual>(builder, type, vectorBoolType, "UnorderedLessThanEqual", lightningType, lightningType);
    AddFunction<OpType::OpFUnordGreaterThan>(builder, type, vectorBoolType, "UnorderedGreaterThan", lightningType, lightningType);
    AddFunction<OpType::OpFUnordGreaterThanEqual>(builder, type, vectorBoolType, "UnorderedGreaterThanEqual", lightningType, lightningType);
  ...
  for(size_t y = 2; y <= 4; ++y)
  {
    ...
    {
      LightningShaderIRType* shaderType = types.GetMatrixType(y, x);
      ...
      //AddFunction<OpType::OpMatrixTimesMatrix>(builder, type, lightningType, "MatrixTimesMatrix", lightningType, lightningType);
    }
  }
  ...
  for(size_t i = 0; i < types.mRealVectorTypes.Size(); ++i)
  {
    Lightning::BoundType* lightningRealType = types.mRealVectorTypes[i]->mLightningType;
    Lightning::BoundType* lightningIntType = types.mIntegerVectorTypes[i]->mLightningType;
    Lightning::BoundType* lightningBoolType = types.mBooleanVectorTypes[i]->mLightningType;
...
LightningDefineType(ShaderIntrinsics, builder, type)
{
  ...
  Lightning::Function* isLanguageFn = builder.AddBoundFunction(type, "IsLanguage", Plasma::DummyBoundFunction, parameters, boolType, Lightning::FunctionOptions::Static);
  ...
  isLanguageFn = builder.AddBoundFunction(type, "IsLanguage", Plasma::DummyBoundFunction, parameters, boolType, Lightning::FunctionOptions::Static);
