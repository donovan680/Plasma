...
//-------------------------------------------------------------------------------------- Plasma Static
/// Global functionality exposed to Lightning script. Bound as "Plasma" to script (e.g. Plasma.Keyboard)
/// PlasmaStatic was used to avoid the conflict with namespace Plasma).
class PlasmaStatic
{
public:
...
{
public:
  LightningScriptConnection(DelegateParam delagate);
  ~LightningScriptConnection();
