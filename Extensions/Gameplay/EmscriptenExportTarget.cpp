...
{
  {
    ...
    // Copy the web build of Plasma Engine to the the specified export folder location
    ...
    // PlasmaEditor.data is the name that the web build expects the virtual file system to be
    ...
    // Using the above saved locations of content within the PlasmaEditor.js file build 
