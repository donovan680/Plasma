...
// helper functions on a LightningCompositor and the actual script editor display.
...
public:
  ...
  // Helper functions
  //void CompileAndTranslateFragments(SimpleLightningShaderGenerator& shaderGenerator);
  //void TranslateMaterial(SimpleLightningShaderGenerator& shaderGenerator, Material* material);
...
// Builds the lightning script representing a composite from a material. As long as this editor is open
